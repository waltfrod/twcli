...
const TailwindCssVersion = "v3.4.3"
...
func (r *Register) String() string { // {{{
	return fmt.Sprintf("󱏿  %s - %s - %s", r.Section, r.Subsection, r.Description)
} // }}}
...
var Items = []Register{
	{
		...
		Description: "Utilidades para controlar la relación de aspecto de un elemento.",
		URL:         "https://tailwindcss.com/docs/aspect-ratio",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	},
	{
		...
		Description: "Un componente para fijar la anchura de un elemento al punto de ruptura actual.",
		URL:         "https://tailwindcss.com/docs/container",
		Header:      []string{`Class`, `Breakpoint`, `Properties`},
		Body: [][]string{
	...
	},
	{
		Section:     "Layout",
		Subsection:  "Columns",
		Description: "Utilidades para controlar el número de columnas de un elemento.",
	...
	{
		Section:     "Layout",
		Subsection:  "Break After",
		Description: "Utilidades para controlar cómo debe romperse una columna o página después de un elemento.",
	...
	{
		Section:     "Layout",
		Subsection:  "Break Before",
		Description: "Utilidades para controlar cómo debe romperse una columna o página antes de un elemento.",
	...
	{
		Section:     "Layout",
		Subsection:  "Break Inside",
		Description: "Utilidades para controlar cómo debe romperse una columna o página dentro de un elemento.",
	...
	{
		Section:     "Layout",
		Subsection:  "Box Decoration Break",
		Description: "Utilidades para controlar cómo deben mostrarse los fragmentos de elementos en varias líneas, columnas o páginas.",
	...
	},
	{
		...
		Description: "Utilidades para controlar cómo debe calcular el navegador el tamaño total de un elemento.",
	...
	},
	{
		Section:     "Layout",
		Subsection:  "Display",
		Description: "Utilidades para controlar el tipo de caja de visualización de un elemento.",
	...
	},
	{
		Section:     "Layout",
		Subsection:  "Floats",
		Description: "Utilidades para controlar el ajuste del contenido alrededor de un elemento.",
		URL:         "https://tailwindcss.com/docs/floats",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	},
	{
		...
		Description: "Utilidades para controlar si un elemento debe crear explícitamente un nuevo contexto de apilamiento.",
	...
	{
		Section:     "Layout",
		Subsection:  "Object Fit",
		Description: "Utilidades para controlar el tamaño del contenido de un elemento reemplazado.",
	...
	{
		Section:     "Layout",
		Subsection:  "Object Position",
		Description: "Utilidades para controlar cómo debe posicionarse el contenido de un elemento reemplazado dentro de su contenedor.",
	...
	},
	{
		Section:     "Layout",
		Subsection:  "Overflow",
		Description: "Utilidades para controlar cómo un elemento maneja el contenido que es demasiado grande para el contenedor.",
	...
	{
		Section:     "Layout",
		Subsection:  "Overscroll Behavior",
		Description: "Utilidades para controlar cómo se comporta el navegador cuando alcanza el límite de un área de desplazamiento.",
	...
	},
	{
		Section:     "Layout",
		Subsection:  "Position",
		Description: "Utilidades para controlar la posición de un elemento en el DOM.",
		URL:         "https://tailwindcss.com/docs/positioning",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	{
		Section:     "Layout",
		Subsection:  "Top / Right / Bottom / Left",
		Description: "Utilidades para controlar la colocación de elementos posicionados.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la visibilidad de un elemento.",
	...
	},
	{
		Section:     "Spacing",
		Subsection:  "Padding",
		Description: "Utilidades para controlar el relleno de un elemento.",
	...
	},
	{
		Section:     "Spacing",
		Subsection:  "Margin",
		Description: "Utilidades para controlar el margen de un elemento.",
	...
	{
		Section:     "Spacing",
		Subsection:  "Space Between",
		Description: "Utilidades para controlar el espacio entre elementos hijos.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el tamaño inicial de los elementos flexibles.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la dirección de los elementos flexibles.",
	...
	},
	{
		...
		Description: "Utilidades para controlar cómo se envuelven los elementos flexibles.",
		URL:         "https://tailwindcss.com/docs/flexbox-wrapping",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	},
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Flex",
		Description: "Utilidades para controlar el crecimiento y la contracción de los elementos flexibles.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Flex Grow",
		Description: "Utilidades para controlar el crecimiento de los elementos flexibles.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la contracción de los elementos flexibles.",
	...
	},
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Order",
		Description: "Utilidades para controlar el orden de los elementos flexibles y de cuadrícula.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Grid Template Columns",
		Description: "Utilidades para especificar las columnas de una cuadrícula.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Grid Column Start / End",
		Description: "Utilidades para controlar el tamaño de los elementos y su colocación en las columnas de la rejilla.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Grid Template Rows",
		Description: "Utilidades para especificar las filas de una cuadrícula.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Grid Row Start / End",
		Description: "Utilidades para controlar el tamaño y la ubicación de los elementos en las filas de la rejilla.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Grid Auto Flow",
		Description: "Utilidades para controlar la colocación automática de los elementos en una rejilla.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Grid Auto Columns",
		Description: "Utilidades para controlar el tamaño de las columnas de la rejilla creadas implícitamente.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Grid Auto Rows",
		Description: "Utilidades para controlar el tamaño de las filas de la rejilla creadas implícitamente.",
	...
	},
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Gap",
		Description: "Utilidades para controlar los medianiles entre elementos de rejilla y flexbox.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la posición de los elementos flex y grid a lo largo del eje principal de un contenedor.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Justify Items",
		Description: "Utilidades para controlar cómo se alinean los elementos de la rejilla a lo largo de su eje en línea.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Justify Self",
		Description: "Utilidades para controlar cómo se alinea un elemento de rejilla individual a lo largo de su eje en línea.",
	...
	},
	{
		...
		Description: "Utilidades para controlar cómo se posicionan las filas en contenedores flex y de rejilla de varias filas.",
	...
	},
	{
		...
		Description: "Utilidades para controlar cómo se posicionan los elementos flex y grid a lo largo del eje transversal de un contenedor.",
		URL:         "https://tailwindcss.com/docs/flexbox-align-items",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	},
	{
		...
		Description: "Utilidades para controlar cómo se posiciona un elemento individual de flex o rejilla a lo largo del eje transversal de su contenedor.",
		URL:         "https://tailwindcss.com/docs/flexbox-align-self",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Place Content",
		Description: "Utilidades para controlar cómo se justifica y alinea el contenido al mismo tiempo.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Place Items",
		Description: "Utilidades para controlar cómo se justifican y alinean los elementos al mismo tiempo.",
	...
	{
		Section:     "Flexbox & Grid",
		Subsection:  "Place Self",
		Description: "Utilidades para controlar cómo se justifica y alinea un elemento individual al mismo tiempo.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el radio del borde de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la anchura de los bordes de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el color de los bordes de un elemento.",
		...
		Body: [][]string{
			...
			{
				`border-x-white`,
				`border-left-color: rgb(255 255 255); border-right-color: rgb(255 255 255);`,
			},
			{
				`border-x-slate-50`,
				`border-left-color: rgb(248 250 252); border-right-color: rgb(248 250 252);`,
			},
			{
				`border-x-slate-100`,
				`border-left-color: rgb(241 245 249); border-right-color: rgb(241 245 249);`,
			},
			{
				`border-x-slate-200`,
				`border-left-color: rgb(226 232 240); border-right-color: rgb(226 232 240);`,
			},
			{
				`border-x-slate-300`,
				`border-left-color: rgb(203 213 225); border-right-color: rgb(203 213 225);`,
			},
			{
				`border-x-slate-400`,
				`border-left-color: rgb(148 163 184); border-right-color: rgb(148 163 184);`,
			},
			{
				`border-x-slate-500`,
				`border-left-color: rgb(100 116 139); border-right-color: rgb(100 116 139);`,
			},
			{
				`border-x-slate-600`,
				`border-left-color: rgb(71 85 105); border-right-color: rgb(71 85 105);`,
			},
			{
				`border-x-slate-700`,
				`border-left-color: rgb(51 65 85); border-right-color: rgb(51 65 85);`,
			},
			{
				`border-x-slate-800`,
				`border-left-color: rgb(30 41 59); border-right-color: rgb(30 41 59);`,
			},
			{
				`border-x-slate-900`,
				`border-left-color: rgb(15 23 42); border-right-color: rgb(15 23 42);`,
			},
			{
				`border-x-slate-950`,
				`border-left-color: rgb(2 6 23); border-right-color: rgb(2 6 23);`,
			},
			{
				`border-x-gray-50`,
				`border-left-color: rgb(249 250 251); border-right-color: rgb(249 250 251);`,
			},
			{
				`border-x-gray-100`,
				`border-left-color: rgb(243 244 246); border-right-color: rgb(243 244 246);`,
			},
			{
				`border-x-gray-200`,
				`border-left-color: rgb(229 231 235); border-right-color: rgb(229 231 235);`,
			},
			{
				`border-x-gray-300`,
				`border-left-color: rgb(209 213 219); border-right-color: rgb(209 213 219);`,
			},
			{
				`border-x-gray-400`,
				`border-left-color: rgb(156 163 175); border-right-color: rgb(156 163 175);`,
			},
			{
				`border-x-gray-500`,
				`border-left-color: rgb(107 114 128); border-right-color: rgb(107 114 128);`,
			},
			{
				`border-x-gray-600`,
				`border-left-color: rgb(75 85 99); border-right-color: rgb(75 85 99);`,
			},
			{
				`border-x-gray-700`,
				`border-left-color: rgb(55 65 81); border-right-color: rgb(55 65 81);`,
			},
			{
				`border-x-gray-800`,
			...
			{
				`border-x-gray-950`,
				`border-left-color: rgb(3 7 18); border-right-color: rgb(3 7 18);`,
			},
			{
				`border-x-zinc-50`,
				`border-left-color: rgb(250 250 250); border-right-color: rgb(250 250 250);`,
			},
			{
				`border-x-zinc-100`,
				`border-left-color: rgb(244 244 245); border-right-color: rgb(244 244 245);`,
			},
			{
				`border-x-zinc-200`,
				`border-left-color: rgb(228 228 231); border-right-color: rgb(228 228 231);`,
			},
			{
				`border-x-zinc-300`,
				`border-left-color: rgb(212 212 216); border-right-color: rgb(212 212 216);`,
			},
			{
				`border-x-zinc-400`,
				`border-left-color: rgb(161 161 170); border-right-color: rgb(161 161 170);`,
			},
			{
				`border-x-zinc-500`,
				`border-left-color: rgb(113 113 122); border-right-color: rgb(113 113 122);`,
			},
			{
				`border-x-zinc-600`,
			...
			{
				`border-x-zinc-700`,
				`border-left-color: rgb(63 63 70); border-right-color: rgb(63 63 70);`,
			},
			{
				`border-x-zinc-800`,
				`border-left-color: rgb(39 39 42); border-right-color: rgb(39 39 42);`,
			},
			{
				`border-x-zinc-900`,
				`border-left-color: rgb(24 24 27); border-right-color: rgb(24 24 27);`,
			},
			{
				`border-x-zinc-950`,
				`border-left-color: rgb(9 9 11); border-right-color: rgb(9 9 11);`,
			},
			{
				`border-x-neutral-50`,
				`border-left-color: rgb(250 250 250); border-right-color: rgb(250 250 250);`,
			},
			{
				...
				`border-left-color: rgb(245 245 245); border-right-color: rgb(245 245 245);`,
			},
			{
				`border-x-neutral-200`,
				`border-left-color: rgb(229 229 229); border-right-color: rgb(229 229 229);`,
			},
			{
				`border-x-neutral-300`,
				`border-left-color: rgb(212 212 212); border-right-color: rgb(212 212 212);`,
			},
			{
				`border-x-neutral-400`,
				`border-left-color: rgb(163 163 163); border-right-color: rgb(163 163 163);`,
			},
			{
				`border-x-neutral-500`,
				`border-left-color: rgb(115 115 115); border-right-color: rgb(115 115 115);`,
			},
			{
				`border-x-neutral-600`,
				`border-left-color: rgb(82 82 82); border-right-color: rgb(82 82 82);`,
			},
			{
				`border-x-neutral-700`,
				`border-left-color: rgb(64 64 64); border-right-color: rgb(64 64 64);`,
			},
			{
				`border-x-neutral-800`,
				`border-left-color: rgb(38 38 38); border-right-color: rgb(38 38 38);`,
			},
			{
				`border-x-neutral-900`,
				`border-left-color: rgb(23 23 23); border-right-color: rgb(23 23 23);`,
			},
			{
				`border-x-neutral-950`,
				`border-left-color: rgb(10 10 10); border-right-color: rgb(10 10 10);`,
			},
			{
				`border-x-stone-50`,
				`border-left-color: rgb(250 250 249); border-right-color: rgb(250 250 249);`,
			},
			{
				`border-x-stone-100`,
				`border-left-color: rgb(245 245 244); border-right-color: rgb(245 245 244);`,
			},
			{
				`border-x-stone-200`,
				`border-left-color: rgb(231 229 228); border-right-color: rgb(231 229 228);`,
			},
			{
				`border-x-stone-300`,
				`border-left-color: rgb(214 211 209); border-right-color: rgb(214 211 209);`,
			},
			{
				`border-x-stone-400`,
				`border-left-color: rgb(168 162 158); border-right-color: rgb(168 162 158);`,
			},
			{
				`border-x-stone-500`,
				`border-left-color: rgb(120 113 108); border-right-color: rgb(120 113 108);`,
			},
			{
				`border-x-stone-600`,
				`border-left-color: rgb(87 83 78); border-right-color: rgb(87 83 78);`,
			},
			{
				`border-x-stone-700`,
				`border-left-color: rgb(68 64 60); border-right-color: rgb(68 64 60);`,
			},
			{
				`border-x-stone-800`,
				`border-left-color: rgb(41 37 36); border-right-color: rgb(41 37 36);`,
			},
			{
				`border-x-stone-900`,
				`border-left-color: rgb(28 25 23); border-right-color: rgb(28 25 23);`,
			},
			{
				`border-x-stone-950`,
				`border-left-color: rgb(12 10 9); border-right-color: rgb(12 10 9);`,
			},
			{
				`border-x-red-50`,
				`border-left-color: rgb(254 242 242); border-right-color: rgb(254 242 242);`,
			},
			{
				`border-x-red-100`,
				`border-left-color: rgb(254 226 226); border-right-color: rgb(254 226 226);`,
			},
			{
				`border-x-red-200`,
				`border-left-color: rgb(254 202 202); border-right-color: rgb(254 202 202);`,
			},
			{
				`border-x-red-300`,
				`border-left-color: rgb(252 165 165); border-right-color: rgb(252 165 165);`,
			},
			{
				`border-x-red-400`,
			...
			{
				`border-x-red-500`,
				`border-left-color: rgb(239 68 68); border-right-color: rgb(239 68 68);`,
			},
			{
				`border-x-red-600`,
				`border-left-color: rgb(220 38 38); border-right-color: rgb(220 38 38);`,
			},
			{
				`border-x-red-700`,
				`border-left-color: rgb(185 28 28); border-right-color: rgb(185 28 28);`,
			},
			{
				`border-x-red-800`,
				`border-left-color: rgb(153 27 27); border-right-color: rgb(153 27 27);`,
			},
			{
				`border-x-red-900`,
				`border-left-color: rgb(127 29 29); border-right-color: rgb(127 29 29);`,
			},
			{
				`border-x-red-950`,
				`border-left-color: rgb(69 10 10); border-right-color: rgb(69 10 10);`,
			},
			{
				`border-x-orange-50`,
				`border-left-color: rgb(255 247 237); border-right-color: rgb(255 247 237);`,
			},
			{
				`border-x-orange-100`,
				`border-left-color: rgb(255 237 213); border-right-color: rgb(255 237 213);`,
			},
			{
				`border-x-orange-200`,
				`border-left-color: rgb(254 215 170); border-right-color: rgb(254 215 170);`,
			},
			{
				`border-x-orange-300`,
				`border-left-color: rgb(253 186 116); border-right-color: rgb(253 186 116);`,
			},
			{
				`border-x-orange-400`,
				`border-left-color: rgb(251 146 60); border-right-color: rgb(251 146 60);`,
			},
			{
				`border-x-orange-500`,
				`border-left-color: rgb(249 115 22); border-right-color: rgb(249 115 22);`,
			},
			{
				`border-x-orange-600`,
				`border-left-color: rgb(234 88 12); border-right-color: rgb(234 88 12);`,
			},
			{
				`border-x-orange-700`,
				`border-left-color: rgb(194 65 12); border-right-color: rgb(194 65 12);`,
			},
			{
				`border-x-orange-800`,
				`border-left-color: rgb(154 52 18); border-right-color: rgb(154 52 18);`,
			},
			{
				`border-x-orange-900`,
				`border-left-color: rgb(124 45 18); border-right-color: rgb(124 45 18);`,
			},
			{
				`border-x-orange-950`,
				`border-left-color: rgb(67 20 7); border-right-color: rgb(67 20 7);`,
			},
			{
				`border-x-amber-50`,
				`border-left-color: rgb(255 251 235); border-right-color: rgb(255 251 235);`,
			},
			{
				`border-x-amber-100`,
				`border-left-color: rgb(254 243 199); border-right-color: rgb(254 243 199);`,
			},
			{
				`border-x-amber-200`,
				`border-left-color: rgb(253 230 138); border-right-color: rgb(253 230 138);`,
			},
			{
				`border-x-amber-300`,
				`border-left-color: rgb(252 211 77); border-right-color: rgb(252 211 77);`,
			},
			{
				`border-x-amber-400`,
				`border-left-color: rgb(251 191 36); border-right-color: rgb(251 191 36);`,
			},
			{
				`border-x-amber-500`,
				`border-left-color: rgb(245 158 11); border-right-color: rgb(245 158 11);`,
			},
			{
				`border-x-amber-600`,
				`border-left-color: rgb(217 119 6); border-right-color: rgb(217 119 6);`,
			},
			{
				`border-x-amber-700`,
				`border-left-color: rgb(180 83 9); border-right-color: rgb(180 83 9);`,
			},
			{
				`border-x-amber-800`,
				`border-left-color: rgb(146 64 14); border-right-color: rgb(146 64 14);`,
			},
			{
				`border-x-amber-900`,
				`border-left-color: rgb(120 53 15); border-right-color: rgb(120 53 15);`,
			},
			{
				`border-x-amber-950`,
				`border-left-color: rgb(69 26 3); border-right-color: rgb(69 26 3);`,
			},
			{
				`border-x-yellow-50`,
				`border-left-color: rgb(254 252 232); border-right-color: rgb(254 252 232);`,
			},
			{
				`border-x-yellow-100`,
				`border-left-color: rgb(254 249 195); border-right-color: rgb(254 249 195);`,
			},
			{
				`border-x-yellow-200`,
				`border-left-color: rgb(254 240 138); border-right-color: rgb(254 240 138);`,
			},
			{
				`border-x-yellow-300`,
				`border-left-color: rgb(253 224 71); border-right-color: rgb(253 224 71);`,
			},
			{
				`border-x-yellow-400`,
				`border-left-color: rgb(250 204 21); border-right-color: rgb(250 204 21);`,
			},
			{
				`border-x-yellow-500`,
				`border-left-color: rgb(234 179 8); border-right-color: rgb(234 179 8);`,
			},
			{
				`border-x-yellow-600`,
				`border-left-color: rgb(202 138 4); border-right-color: rgb(202 138 4);`,
			},
			{
				`border-x-yellow-700`,
				`border-left-color: rgb(161 98 7); border-right-color: rgb(161 98 7);`,
			},
			{
				`border-x-yellow-800`,
				`border-left-color: rgb(133 77 14); border-right-color: rgb(133 77 14);`,
			},
			{
				`border-x-yellow-900`,
				`border-left-color: rgb(113 63 18); border-right-color: rgb(113 63 18);`,
			},
			{
				`border-x-yellow-950`,
				`border-left-color: rgb(66 32 6); border-right-color: rgb(66 32 6);`,
			},
			{
				`border-x-lime-50`,
				`border-left-color: rgb(247 254 231); border-right-color: rgb(247 254 231);`,
			},
			{
				`border-x-lime-100`,
				`border-left-color: rgb(236 252 203); border-right-color: rgb(236 252 203);`,
			},
			{
				`border-x-lime-200`,
				`border-left-color: rgb(217 249 157); border-right-color: rgb(217 249 157);`,
			},
			{
				`border-x-lime-300`,
				`border-left-color: rgb(190 242 100); border-right-color: rgb(190 242 100);`,
			},
			{
				`border-x-lime-400`,
				`border-left-color: rgb(163 230 53); border-right-color: rgb(163 230 53);`,
			},
			{
				`border-x-lime-500`,
				`border-left-color: rgb(132 204 22); border-right-color: rgb(132 204 22);`,
			},
			{
				`border-x-lime-600`,
				`border-left-color: rgb(101 163 13); border-right-color: rgb(101 163 13);`,
			},
			{
				`border-x-lime-700`,
				`border-left-color: rgb(77 124 15); border-right-color: rgb(77 124 15);`,
			},
			{
				`border-x-lime-800`,
				`border-left-color: rgb(63 98 18); border-right-color: rgb(63 98 18);`,
			},
			{
				`border-x-lime-900`,
			...
			{
				`border-x-lime-950`,
				`border-left-color: rgb(26 46 5); border-right-color: rgb(26 46 5);`,
			},
			{
				`border-x-green-50`,
				`border-left-color: rgb(240 253 244); border-right-color: rgb(240 253 244);`,
			},
			{
				`border-x-green-100`,
				`border-left-color: rgb(220 252 231); border-right-color: rgb(220 252 231);`,
			},
			{
				`border-x-green-200`,
				`border-left-color: rgb(187 247 208); border-right-color: rgb(187 247 208);`,
			},
			{
				`border-x-green-300`,
				`border-left-color: rgb(134 239 172); border-right-color: rgb(134 239 172);`,
			},
			{
				`border-x-green-400`,
				`border-left-color: rgb(74 222 128); border-right-color: rgb(74 222 128);`,
			},
			{
				`border-x-green-500`,
				`border-left-color: rgb(34 197 94); border-right-color: rgb(34 197 94);`,
			},
			{
				`border-x-green-600`,
				`border-left-color: rgb(22 163 74); border-right-color: rgb(22 163 74);`,
			},
			{
				`border-x-green-700`,
				`border-left-color: rgb(21 128 61); border-right-color: rgb(21 128 61);`,
			},
			{
				`border-x-green-800`,
				`border-left-color: rgb(22 101 52); border-right-color: rgb(22 101 52);`,
			},
			{
				`border-x-green-900`,
				`border-left-color: rgb(20 83 45); border-right-color: rgb(20 83 45);`,
			},
			{
				`border-x-green-950`,
				`border-left-color: rgb(5 46 22); border-right-color: rgb(5 46 22);`,
			},
			{
				`border-x-emerald-50`,
				`border-left-color: rgb(236 253 245); border-right-color: rgb(236 253 245);`,
			},
			{
				`border-x-emerald-100`,
				`border-left-color: rgb(209 250 229); border-right-color: rgb(209 250 229);`,
			},
			{
				`border-x-emerald-200`,
				`border-left-color: rgb(167 243 208); border-right-color: rgb(167 243 208);`,
			},
			{
				`border-x-emerald-300`,
				`border-left-color: rgb(110 231 183); border-right-color: rgb(110 231 183);`,
			},
			{
				`border-x-emerald-400`,
				`border-left-color: rgb(52 211 153); border-right-color: rgb(52 211 153);`,
			},
			{
				`border-x-emerald-500`,
				`border-left-color: rgb(16 185 129); border-right-color: rgb(16 185 129);`,
			},
			{
				`border-x-emerald-600`,
				`border-left-color: rgb(5 150 105); border-right-color: rgb(5 150 105);`,
			},
			{
				`border-x-emerald-700`,
				`border-left-color: rgb(4 120 87); border-right-color: rgb(4 120 87);`,
			},
			{
				`border-x-emerald-800`,
				`border-left-color: rgb(6 95 70); border-right-color: rgb(6 95 70);`,
			},
			{
				`border-x-emerald-900`,
				`border-left-color: rgb(6 78 59); border-right-color: rgb(6 78 59);`,
			},
			{
				`border-x-emerald-950`,
				`border-left-color: rgb(2 44 34); border-right-color: rgb(2 44 34);`,
			},
			{
				`border-x-teal-50`,
				`border-left-color: rgb(240 253 250); border-right-color: rgb(240 253 250);`,
			},
			{
				`border-x-teal-100`,
				`border-left-color: rgb(204 251 241); border-right-color: rgb(204 251 241);`,
			},
			{
				`border-x-teal-200`,
				`border-left-color: rgb(153 246 228); border-right-color: rgb(153 246 228);`,
			},
			{
				`border-x-teal-300`,
				`border-left-color: rgb(94 234 212); border-right-color: rgb(94 234 212);`,
			},
			{
				`border-x-teal-400`,
				`border-left-color: rgb(45 212 191); border-right-color: rgb(45 212 191);`,
			},
			{
				`border-x-teal-500`,
				`border-left-color: rgb(20 184 166); border-right-color: rgb(20 184 166);`,
			},
			{
				`border-x-teal-600`,
				`border-left-color: rgb(13 148 136); border-right-color: rgb(13 148 136);`,
			},
			{
				`border-x-teal-700`,
				`border-left-color: rgb(15 118 110); border-right-color: rgb(15 118 110);`,
			},
			{
				`border-x-teal-800`,
				`border-left-color: rgb(17 94 89); border-right-color: rgb(17 94 89);`,
			},
			{
				`border-x-teal-900`,
				`border-left-color: rgb(19 78 74); border-right-color: rgb(19 78 74);`,
			},
			{
				`border-x-teal-950`,
				`border-left-color: rgb(4 47 46); border-right-color: rgb(4 47 46);`,
			},
			{
				`border-x-cyan-50`,
				`border-left-color: rgb(236 254 255); border-right-color: rgb(236 254 255);`,
			},
			{
				`border-x-cyan-100`,
				`border-left-color: rgb(207 250 254); border-right-color: rgb(207 250 254);`,
			},
			{
				`border-x-cyan-200`,
				`border-left-color: rgb(165 243 252); border-right-color: rgb(165 243 252);`,
			},
			{
				`border-x-cyan-300`,
				`border-left-color: rgb(103 232 249); border-right-color: rgb(103 232 249);`,
			},
			{
				`border-x-cyan-400`,
				`border-left-color: rgb(34 211 238); border-right-color: rgb(34 211 238);`,
			},
			{
				`border-x-cyan-500`,
				`border-left-color: rgb(6 182 212); border-right-color: rgb(6 182 212);`,
			},
			{
				`border-x-cyan-600`,
				`border-left-color: rgb(8 145 178); border-right-color: rgb(8 145 178);`,
			},
			{
				`border-x-cyan-700`,
				`border-left-color: rgb(14 116 144); border-right-color: rgb(14 116 144);`,
			},
			{
				`border-x-cyan-800`,
				`border-left-color: rgb(21 94 117); border-right-color: rgb(21 94 117);`,
			},
			{
				`border-x-cyan-900`,
				`border-left-color: rgb(22 78 99); border-right-color: rgb(22 78 99);`,
			},
			{
				`border-x-cyan-950`,
				`border-left-color: rgb(8 51 68); border-right-color: rgb(8 51 68);`,
			},
			{
				`border-x-sky-50`,
				`border-left-color: rgb(240 249 255); border-right-color: rgb(240 249 255);`,
			},
			{
				`border-x-sky-100`,
			...
			{
				`border-x-sky-200`,
				`border-left-color: rgb(186 230 253); border-right-color: rgb(186 230 253);`,
			},
			{
				`border-x-sky-300`,
				`border-left-color: rgb(125 211 252); border-right-color: rgb(125 211 252);`,
			},
			{
				`border-x-sky-400`,
				`border-left-color: rgb(56 189 248); border-right-color: rgb(56 189 248);`,
			},
			{
				`border-x-sky-500`,
				`border-left-color: rgb(14 165 233); border-right-color: rgb(14 165 233);`,
			},
			{
				`border-x-sky-600`,
				`border-left-color: rgb(2 132 199); border-right-color: rgb(2 132 199);`,
			},
			{
				`border-x-sky-700`,
				`border-left-color: rgb(3 105 161); border-right-color: rgb(3 105 161);`,
			},
			{
				`border-x-sky-800`,
				`border-left-color: rgb(7 89 133); border-right-color: rgb(7 89 133);`,
			},
			{
				`border-x-sky-900`,
				`border-left-color: rgb(12 74 110); border-right-color: rgb(12 74 110);`,
			},
			{
				`border-x-sky-950`,
				`border-left-color: rgb(8 47 73); border-right-color: rgb(8 47 73);`,
			},
			{
				`border-x-blue-50`,
				`border-left-color: rgb(239 246 255); border-right-color: rgb(239 246 255);`,
			},
			{
				`border-x-blue-100`,
				`border-left-color: rgb(219 234 254); border-right-color: rgb(219 234 254);`,
			},
			{
				`border-x-blue-200`,
				`border-left-color: rgb(191 219 254); border-right-color: rgb(191 219 254);`,
			},
			{
				`border-x-blue-300`,
				`border-left-color: rgb(147 197 253); border-right-color: rgb(147 197 253);`,
			},
			{
				`border-x-blue-400`,
				`border-left-color: rgb(96 165 250); border-right-color: rgb(96 165 250);`,
			},
			{
				`border-x-blue-500`,
				`border-left-color: rgb(59 130 246); border-right-color: rgb(59 130 246);`,
			},
			{
				`border-x-blue-600`,
				`border-left-color: rgb(37 99 235); border-right-color: rgb(37 99 235);`,
			},
			{
				`border-x-blue-700`,
				`border-left-color: rgb(29 78 216); border-right-color: rgb(29 78 216);`,
			},
			{
				`border-x-blue-800`,
				`border-left-color: rgb(30 64 175); border-right-color: rgb(30 64 175);`,
			},
			{
				`border-x-blue-900`,
				`border-left-color: rgb(30 58 138); border-right-color: rgb(30 58 138);`,
			},
			{
				`border-x-blue-950`,
				`border-left-color: rgb(23 37 84); border-right-color: rgb(23 37 84);`,
			},
			{
				`border-x-indigo-50`,
				`border-left-color: rgb(238 242 255); border-right-color: rgb(238 242 255);`,
			},
			{
				`border-x-indigo-100`,
				`border-left-color: rgb(224 231 255); border-right-color: rgb(224 231 255);`,
			},
			{
				`border-x-indigo-200`,
				`border-left-color: rgb(199 210 254); border-right-color: rgb(199 210 254);`,
			},
			{
				`border-x-indigo-300`,
				`border-left-color: rgb(165 180 252); border-right-color: rgb(165 180 252);`,
			},
			{
				`border-x-indigo-400`,
				`border-left-color: rgb(129 140 248); border-right-color: rgb(129 140 248);`,
			},
			{
				`border-x-indigo-500`,
				`border-left-color: rgb(99 102 241); border-right-color: rgb(99 102 241);`,
			},
			{
				`border-x-indigo-600`,
				`border-left-color: rgb(79 70 229); border-right-color: rgb(79 70 229);`,
			},
			{
				`border-x-indigo-700`,
				`border-left-color: rgb(67 56 202); border-right-color: rgb(67 56 202);`,
			},
			{
				`border-x-indigo-800`,
				`border-left-color: rgb(55 48 163); border-right-color: rgb(55 48 163);`,
			},
			{
				`border-x-indigo-900`,
				`border-left-color: rgb(49 46 129); border-right-color: rgb(49 46 129);`,
			},
			{
				`border-x-indigo-950`,
				`border-left-color: rgb(30 27 75); border-right-color: rgb(30 27 75);`,
			},
			{
				`border-x-violet-50`,
				`border-left-color: rgb(245 243 255); border-right-color: rgb(245 243 255);`,
			},
			{
				`border-x-violet-100`,
				`border-left-color: rgb(237 233 254); border-right-color: rgb(237 233 254);`,
			},
			{
				`border-x-violet-200`,
				`border-left-color: rgb(221 214 254); border-right-color: rgb(221 214 254);`,
			},
			{
				`border-x-violet-300`,
				`border-left-color: rgb(196 181 253); border-right-color: rgb(196 181 253);`,
			},
			{
				`border-x-violet-400`,
				`border-left-color: rgb(167 139 250); border-right-color: rgb(167 139 250);`,
			},
			{
				`border-x-violet-500`,
				`border-left-color: rgb(139 92 246); border-right-color: rgb(139 92 246);`,
			},
			{
				`border-x-violet-600`,
				`border-left-color: rgb(124 58 237); border-right-color: rgb(124 58 237);`,
			},
			{
				`border-x-violet-700`,
				`border-left-color: rgb(109 40 217); border-right-color: rgb(109 40 217);`,
			},
			{
				`border-x-violet-800`,
				`border-left-color: rgb(91 33 182); border-right-color: rgb(91 33 182);`,
			},
			{
				`border-x-violet-900`,
				`border-left-color: rgb(76 29 149); border-right-color: rgb(76 29 149);`,
			},
			{
				`border-x-violet-950`,
				`border-left-color: rgb(46 16 101); border-right-color: rgb(46 16 101);`,
			},
			{
				`border-x-purple-50`,
				`border-left-color: rgb(250 245 255); border-right-color: rgb(250 245 255);`,
			},
			{
				`border-x-purple-100`,
				`border-left-color: rgb(243 232 255); border-right-color: rgb(243 232 255);`,
			},
			{
				`border-x-purple-200`,
				`border-left-color: rgb(233 213 255); border-right-color: rgb(233 213 255);`,
			},
			{
				`border-x-purple-300`,
				`border-left-color: rgb(216 180 254); border-right-color: rgb(216 180 254);`,
			},
			{
				`border-x-purple-400`,
				`border-left-color: rgb(192 132 252); border-right-color: rgb(192 132 252);`,
			},
			{
				`border-x-purple-500`,
				`border-left-color: rgb(168 85 247); border-right-color: rgb(168 85 247);`,
			},
			{
				`border-x-purple-600`,
				`border-left-color: rgb(147 51 234); border-right-color: rgb(147 51 234);`,
			},
			{
				`border-x-purple-700`,
				`border-left-color: rgb(126 34 206); border-right-color: rgb(126 34 206);`,
			},
			{
				`border-x-purple-800`,
				`border-left-color: rgb(107 33 168); border-right-color: rgb(107 33 168);`,
			},
			{
				`border-x-purple-900`,
				`border-left-color: rgb(88 28 135); border-right-color: rgb(88 28 135);`,
			},
			{
				`border-x-purple-950`,
				`border-left-color: rgb(59 7 100); border-right-color: rgb(59 7 100);`,
			},
			{
				`border-x-fuchsia-50`,
				`border-left-color: rgb(253 244 255); border-right-color: rgb(253 244 255);`,
			},
			{
				`border-x-fuchsia-100`,
				`border-left-color: rgb(250 232 255); border-right-color: rgb(250 232 255);`,
			},
			{
				`border-x-fuchsia-200`,
				`border-left-color: rgb(245 208 254); border-right-color: rgb(245 208 254);`,
			},
			{
				`border-x-fuchsia-300`,
				`border-left-color: rgb(240 171 252); border-right-color: rgb(240 171 252);`,
			},
			{
				`border-x-fuchsia-400`,
				`border-left-color: rgb(232 121 249); border-right-color: rgb(232 121 249);`,
			},
			{
				`border-x-fuchsia-500`,
				`border-left-color: rgb(217 70 239); border-right-color: rgb(217 70 239);`,
			},
			{
				`border-x-fuchsia-600`,
				`border-left-color: rgb(192 38 211); border-right-color: rgb(192 38 211);`,
			},
			{
				`border-x-fuchsia-700`,
				`border-left-color: rgb(162 28 175); border-right-color: rgb(162 28 175);`,
			},
			{
				`border-x-fuchsia-800`,
				`border-left-color: rgb(134 25 143); border-right-color: rgb(134 25 143);`,
			},
			{
				`border-x-fuchsia-900`,
				`border-left-color: rgb(112 26 117); border-right-color: rgb(112 26 117);`,
			},
			{
				`border-x-fuchsia-950`,
				`border-left-color: rgb(74 4 78); border-right-color: rgb(74 4 78);`,
			},
			{
				`border-x-pink-50`,
				`border-left-color: rgb(253 242 248); border-right-color: rgb(253 242 248);`,
			},
			{
				`border-x-pink-100`,
				`border-left-color: rgb(252 231 243); border-right-color: rgb(252 231 243);`,
			},
			{
				`border-x-pink-200`,
				`border-left-color: rgb(251 207 232); border-right-color: rgb(251 207 232);`,
			},
			{
				`border-x-pink-300`,
				`border-left-color: rgb(249 168 212); border-right-color: rgb(249 168 212);`,
			},
			{
				`border-x-pink-400`,
				`border-left-color: rgb(244 114 182); border-right-color: rgb(244 114 182);`,
			},
			{
				`border-x-pink-500`,
				`border-left-color: rgb(236 72 153); border-right-color: rgb(236 72 153);`,
			},
			{
				`border-x-pink-600`,
				`border-left-color: rgb(219 39 119); border-right-color: rgb(219 39 119);`,
			},
			{
				`border-x-pink-700`,
				`border-left-color: rgb(190 24 93); border-right-color: rgb(190 24 93);`,
			},
			{
				`border-x-pink-800`,
				`border-left-color: rgb(157 23 77); border-right-color: rgb(157 23 77);`,
			},
			{
				`border-x-pink-900`,
				`border-left-color: rgb(131 24 67); border-right-color: rgb(131 24 67);`,
			},
			{
				`border-x-pink-950`,
				`border-left-color: rgb(80 7 36); border-right-color: rgb(80 7 36);`,
			},
			{
				`border-x-rose-50`,
				`border-left-color: rgb(255 241 242); border-right-color: rgb(255 241 242);`,
			},
			{
				`border-x-rose-100`,
				`border-left-color: rgb(255 228 230); border-right-color: rgb(255 228 230);`,
			},
			{
				`border-x-rose-200`,
				`border-left-color: rgb(254 205 211); border-right-color: rgb(254 205 211);`,
			},
			{
				`border-x-rose-300`,
				`border-left-color: rgb(253 164 175); border-right-color: rgb(253 164 175);`,
			},
			{
				`border-x-rose-400`,
				`border-left-color: rgb(251 113 133); border-right-color: rgb(251 113 133);`,
			},
			{
				`border-x-rose-500`,
				`border-left-color: rgb(244 63 94); border-right-color: rgb(244 63 94);`,
			},
			{
				`border-x-rose-600`,
				`border-left-color: rgb(225 29 72); border-right-color: rgb(225 29 72);`,
			},
			{
				`border-x-rose-700`,
				`border-left-color: rgb(190 18 60); border-right-color: rgb(190 18 60);`,
			},
			{
				`border-x-rose-800`,
				`border-left-color: rgb(159 18 57); border-right-color: rgb(159 18 57);`,
			},
			{
				`border-x-rose-900`,
				`border-left-color: rgb(136 19 55); border-right-color: rgb(136 19 55);`,
			},
			{
				`border-x-rose-950`,
				`border-left-color: rgb(76 5 25); border-right-color: rgb(76 5 25);`,
			},
			...
			{
				`border-y-slate-50`,
				`border-top-color: rgb(248 250 252); border-bottom-color: rgb(248 250 252);`,
			},
			{
				`border-y-slate-100`,
				`border-top-color: rgb(241 245 249); border-bottom-color: rgb(241 245 249);`,
			},
			{
				`border-y-slate-200`,
				`border-top-color: rgb(226 232 240); border-bottom-color: rgb(226 232 240);`,
			},
			{
				`border-y-slate-300`,
				`border-top-color: rgb(203 213 225); border-bottom-color: rgb(203 213 225);`,
			},
			{
				`border-y-slate-400`,
				`border-top-color: rgb(148 163 184); border-bottom-color: rgb(148 163 184);`,
			},
			{
				`border-y-slate-500`,
			...
			{
				`border-y-slate-700`,
				`border-top-color: rgb(51 65 85); border-bottom-color: rgb(51 65 85);`,
			},
			{
				`border-y-slate-800`,
				`border-top-color: rgb(30 41 59); border-bottom-color: rgb(30 41 59);`,
			},
			{
				`border-y-slate-900`,
				`border-top-color: rgb(15 23 42); border-bottom-color: rgb(15 23 42);`,
			},
			{
				`border-y-slate-950`,
				`border-top-color: rgb(2 6 23); border-bottom-color: rgb(2 6 23);`,
			},
			{
				`border-y-gray-50`,
				`border-top-color: rgb(249 250 251); border-bottom-color: rgb(249 250 251);`,
			},
			{
				`border-y-gray-100`,
				`border-top-color: rgb(243 244 246); border-bottom-color: rgb(243 244 246);`,
			},
			{
				`border-y-gray-200`,
				`border-top-color: rgb(229 231 235); border-bottom-color: rgb(229 231 235);`,
			},
			{
				`border-y-gray-300`,
				`border-top-color: rgb(209 213 219); border-bottom-color: rgb(209 213 219);`,
			},
			{
				`border-y-gray-400`,
				`border-top-color: rgb(156 163 175); border-bottom-color: rgb(156 163 175);`,
			},
			{
				`border-y-gray-500`,
				`border-top-color: rgb(107 114 128); border-bottom-color: rgb(107 114 128);`,
			},
			{
				`border-y-gray-600`,
				`border-top-color: rgb(75 85 99); border-bottom-color: rgb(75 85 99);`,
			},
			{
				`border-y-gray-700`,
				`border-top-color: rgb(55 65 81); border-bottom-color: rgb(55 65 81);`,
			},
			{
				`border-y-gray-800`,
				`border-top-color: rgb(31 41 55); border-bottom-color: rgb(31 41 55);`,
			},
			{
				`border-y-gray-900`,
				`border-top-color: rgb(17 24 39); border-bottom-color: rgb(17 24 39);`,
			},
			{
				`border-y-gray-950`,
				`border-top-color: rgb(3 7 18); border-bottom-color: rgb(3 7 18);`,
			},
			{
				`border-y-zinc-50`,
				`border-top-color: rgb(250 250 250); border-bottom-color: rgb(250 250 250);`,
			},
			{
				`border-y-zinc-100`,
				`border-top-color: rgb(244 244 245); border-bottom-color: rgb(244 244 245);`,
			},
			{
				`border-y-zinc-200`,
				`border-top-color: rgb(228 228 231); border-bottom-color: rgb(228 228 231);`,
			},
			{
				`border-y-zinc-300`,
				`border-top-color: rgb(212 212 216); border-bottom-color: rgb(212 212 216);`,
			},
			{
				`border-y-zinc-400`,
				`border-top-color: rgb(161 161 170); border-bottom-color: rgb(161 161 170);`,
			},
			{
				`border-y-zinc-500`,
				`border-top-color: rgb(113 113 122); border-bottom-color: rgb(113 113 122);`,
			},
			{
				`border-y-zinc-600`,
				`border-top-color: rgb(82 82 91); border-bottom-color: rgb(82 82 91);`,
			},
			{
				`border-y-zinc-700`,
				`border-top-color: rgb(63 63 70); border-bottom-color: rgb(63 63 70);`,
			},
			{
				`border-y-zinc-800`,
				`border-top-color: rgb(39 39 42); border-bottom-color: rgb(39 39 42);`,
			},
			{
				`border-y-zinc-900`,
				`border-top-color: rgb(24 24 27); border-bottom-color: rgb(24 24 27);`,
			},
			{
				`border-y-zinc-950`,
				`border-top-color: rgb(9 9 11); border-bottom-color: rgb(9 9 11);`,
			},
			{
				`border-y-neutral-50`,
				`border-top-color: rgb(250 250 250); border-bottom-color: rgb(250 250 250);`,
			},
			{
				...
				`border-top-color: rgb(245 245 245); border-bottom-color: rgb(245 245 245);`,
			},
			{
				`border-y-neutral-200`,
				`border-top-color: rgb(229 229 229); border-bottom-color: rgb(229 229 229);`,
			},
			{
				`border-y-neutral-300`,
				`border-top-color: rgb(212 212 212); border-bottom-color: rgb(212 212 212);`,
			},
			{
				`border-y-neutral-400`,
				`border-top-color: rgb(163 163 163); border-bottom-color: rgb(163 163 163);`,
			},
			{
				`border-y-neutral-500`,
				`border-top-color: rgb(115 115 115); border-bottom-color: rgb(115 115 115);`,
			},
			{
				`border-y-neutral-600`,
				`border-top-color: rgb(82 82 82); border-bottom-color: rgb(82 82 82);`,
			},
			{
				`border-y-neutral-700`,
				`border-top-color: rgb(64 64 64); border-bottom-color: rgb(64 64 64);`,
			},
			{
			...
			{
				`border-y-stone-50`,
				`border-top-color: rgb(250 250 249); border-bottom-color: rgb(250 250 249);`,
			},
			{
				`border-y-stone-100`,
				`border-top-color: rgb(245 245 244); border-bottom-color: rgb(245 245 244);`,
			},
			{
				`border-y-stone-200`,
				`border-top-color: rgb(231 229 228); border-bottom-color: rgb(231 229 228);`,
			},
			{
				`border-y-stone-300`,
				`border-top-color: rgb(214 211 209); border-bottom-color: rgb(214 211 209);`,
			},
			{
				`border-y-stone-400`,
				`border-top-color: rgb(168 162 158); border-bottom-color: rgb(168 162 158);`,
			},
			{
				`border-y-stone-500`,
				`border-top-color: rgb(120 113 108); border-bottom-color: rgb(120 113 108);`,
			},
			{
				`border-y-stone-600`,
				`border-top-color: rgb(87 83 78); border-bottom-color: rgb(87 83 78);`,
			},
			{
				`border-y-stone-700`,
				`border-top-color: rgb(68 64 60); border-bottom-color: rgb(68 64 60);`,
			},
			{
				`border-y-stone-800`,
				`border-top-color: rgb(41 37 36); border-bottom-color: rgb(41 37 36);`,
			},
			{
				`border-y-stone-900`,
				`border-top-color: rgb(28 25 23); border-bottom-color: rgb(28 25 23);`,
			},
			{
				`border-y-stone-950`,
				`border-top-color: rgb(12 10 9); border-bottom-color: rgb(12 10 9);`,
			},
			{
				`border-y-red-50`,
			...
			{
				`border-y-red-100`,
				`border-top-color: rgb(254 226 226); border-bottom-color: rgb(254 226 226);`,
			},
			{
				`border-y-red-200`,
				`border-top-color: rgb(254 202 202); border-bottom-color: rgb(254 202 202);`,
			},
			{
				`border-y-red-300`,
				`border-top-color: rgb(252 165 165); border-bottom-color: rgb(252 165 165);`,
			},
			{
				`border-y-red-400`,
				`border-top-color: rgb(248 113 113); border-bottom-color: rgb(248 113 113);`,
			},
			{
				`border-y-red-500`,
				`border-top-color: rgb(239 68 68); border-bottom-color: rgb(239 68 68);`,
			},
			{
				`border-y-red-600`,
				`border-top-color: rgb(220 38 38); border-bottom-color: rgb(220 38 38);`,
			},
			{
				`border-y-red-700`,
				`border-top-color: rgb(185 28 28); border-bottom-color: rgb(185 28 28);`,
			},
			{
				`border-y-red-800`,
				`border-top-color: rgb(153 27 27); border-bottom-color: rgb(153 27 27);`,
			},
			{
				`border-y-red-900`,
				`border-top-color: rgb(127 29 29); border-bottom-color: rgb(127 29 29);`,
			},
			{
				`border-y-red-950`,
				`border-top-color: rgb(69 10 10); border-bottom-color: rgb(69 10 10);`,
			},
			{
				`border-y-orange-50`,
				`border-top-color: rgb(255 247 237); border-bottom-color: rgb(255 247 237);`,
			},
			{
				`border-y-orange-100`,
				`border-top-color: rgb(255 237 213); border-bottom-color: rgb(255 237 213);`,
			},
			{
				`border-y-orange-200`,
				`border-top-color: rgb(254 215 170); border-bottom-color: rgb(254 215 170);`,
			},
			{
				`border-y-orange-300`,
				`border-top-color: rgb(253 186 116); border-bottom-color: rgb(253 186 116);`,
			},
			{
				`border-y-orange-400`,
				`border-top-color: rgb(251 146 60); border-bottom-color: rgb(251 146 60);`,
			},
			{
				`border-y-orange-500`,
				`border-top-color: rgb(249 115 22); border-bottom-color: rgb(249 115 22);`,
			},
			{
				`border-y-orange-600`,
				`border-top-color: rgb(234 88 12); border-bottom-color: rgb(234 88 12);`,
			},
			{
				`border-y-orange-700`,
				`border-top-color: rgb(194 65 12); border-bottom-color: rgb(194 65 12);`,
			},
			{
				`border-y-orange-800`,
				`border-top-color: rgb(154 52 18); border-bottom-color: rgb(154 52 18);`,
			},
			{
				`border-y-orange-900`,
				`border-top-color: rgb(124 45 18); border-bottom-color: rgb(124 45 18);`,
			},
			{
				`border-y-orange-950`,
				`border-top-color: rgb(67 20 7); border-bottom-color: rgb(67 20 7);`,
			},
			{
				`border-y-amber-50`,
				`border-top-color: rgb(255 251 235); border-bottom-color: rgb(255 251 235);`,
			},
			{
				`border-y-amber-100`,
				`border-top-color: rgb(254 243 199); border-bottom-color: rgb(254 243 199);`,
			},
			{
				`border-y-amber-200`,
				`border-top-color: rgb(253 230 138); border-bottom-color: rgb(253 230 138);`,
			},
			{
				`border-y-amber-300`,
				`border-top-color: rgb(252 211 77); border-bottom-color: rgb(252 211 77);`,
			},
			{
				`border-y-amber-400`,
				`border-top-color: rgb(251 191 36); border-bottom-color: rgb(251 191 36);`,
			},
			{
				`border-y-amber-500`,
				`border-top-color: rgb(245 158 11); border-bottom-color: rgb(245 158 11);`,
			},
			{
				`border-y-amber-600`,
				`border-top-color: rgb(217 119 6); border-bottom-color: rgb(217 119 6);`,
			},
			{
				`border-y-amber-700`,
				`border-top-color: rgb(180 83 9); border-bottom-color: rgb(180 83 9);`,
			},
			{
				`border-y-amber-800`,
				`border-top-color: rgb(146 64 14); border-bottom-color: rgb(146 64 14);`,
			},
			{
				`border-y-amber-900`,
				`border-top-color: rgb(120 53 15); border-bottom-color: rgb(120 53 15);`,
			},
			{
				`border-y-amber-950`,
				`border-top-color: rgb(69 26 3); border-bottom-color: rgb(69 26 3);`,
			},
			{
				`border-y-yellow-50`,
				`border-top-color: rgb(254 252 232); border-bottom-color: rgb(254 252 232);`,
			},
			{
				`border-y-yellow-100`,
				`border-top-color: rgb(254 249 195); border-bottom-color: rgb(254 249 195);`,
			},
			{
				`border-y-yellow-200`,
				`border-top-color: rgb(254 240 138); border-bottom-color: rgb(254 240 138);`,
			},
			{
				`border-y-yellow-300`,
				`border-top-color: rgb(253 224 71); border-bottom-color: rgb(253 224 71);`,
			},
			{
				`border-y-yellow-400`,
				`border-top-color: rgb(250 204 21); border-bottom-color: rgb(250 204 21);`,
			},
			{
				`border-y-yellow-500`,
				`border-top-color: rgb(234 179 8); border-bottom-color: rgb(234 179 8);`,
			},
			{
				`border-y-yellow-600`,
				`border-top-color: rgb(202 138 4); border-bottom-color: rgb(202 138 4);`,
			},
			{
				`border-y-yellow-700`,
				`border-top-color: rgb(161 98 7); border-bottom-color: rgb(161 98 7);`,
			},
			{
				`border-y-yellow-800`,
				`border-top-color: rgb(133 77 14); border-bottom-color: rgb(133 77 14);`,
			},
			{
				`border-y-yellow-900`,
				`border-top-color: rgb(113 63 18); border-bottom-color: rgb(113 63 18);`,
			},
			{
				`border-y-yellow-950`,
				`border-top-color: rgb(66 32 6); border-bottom-color: rgb(66 32 6);`,
			},
			{
				`border-y-lime-50`,
				`border-top-color: rgb(247 254 231); border-bottom-color: rgb(247 254 231);`,
			},
			{
				`border-y-lime-100`,
				`border-top-color: rgb(236 252 203); border-bottom-color: rgb(236 252 203);`,
			},
			{
				`border-y-lime-200`,
				`border-top-color: rgb(217 249 157); border-bottom-color: rgb(217 249 157);`,
			},
			{
				`border-y-lime-300`,
				`border-top-color: rgb(190 242 100); border-bottom-color: rgb(190 242 100);`,
			},
			{
				`border-y-lime-400`,
				`border-top-color: rgb(163 230 53); border-bottom-color: rgb(163 230 53);`,
			},
			{
				`border-y-lime-500`,
				`border-top-color: rgb(132 204 22); border-bottom-color: rgb(132 204 22);`,
			},
			{
				`border-y-lime-600`,
				`border-top-color: rgb(101 163 13); border-bottom-color: rgb(101 163 13);`,
			},
			{
				`border-y-lime-700`,
				`border-top-color: rgb(77 124 15); border-bottom-color: rgb(77 124 15);`,
			},
			{
				`border-y-lime-800`,
				`border-top-color: rgb(63 98 18); border-bottom-color: rgb(63 98 18);`,
			},
			{
				`border-y-lime-900`,
				`border-top-color: rgb(54 83 20); border-bottom-color: rgb(54 83 20);`,
			},
			{
				`border-y-lime-950`,
				`border-top-color: rgb(26 46 5); border-bottom-color: rgb(26 46 5);`,
			},
			{
				`border-y-green-50`,
				`border-top-color: rgb(240 253 244); border-bottom-color: rgb(240 253 244);`,
			},
			{
				`border-y-green-100`,
				`border-top-color: rgb(220 252 231); border-bottom-color: rgb(220 252 231);`,
			},
			{
				`border-y-green-200`,
				`border-top-color: rgb(187 247 208); border-bottom-color: rgb(187 247 208);`,
			},
			{
				`border-y-green-300`,
				`border-top-color: rgb(134 239 172); border-bottom-color: rgb(134 239 172);`,
			},
			{
				`border-y-green-400`,
				`border-top-color: rgb(74 222 128); border-bottom-color: rgb(74 222 128);`,
			},
			{
				`border-y-green-500`,
				`border-top-color: rgb(34 197 94); border-bottom-color: rgb(34 197 94);`,
			},
			{
				`border-y-green-600`,
				`border-top-color: rgb(22 163 74); border-bottom-color: rgb(22 163 74);`,
			},
			{
				`border-y-green-700`,
				`border-top-color: rgb(21 128 61); border-bottom-color: rgb(21 128 61);`,
			},
			{
				`border-y-green-800`,
				`border-top-color: rgb(22 101 52); border-bottom-color: rgb(22 101 52);`,
			},
			{
				`border-y-green-900`,
				`border-top-color: rgb(20 83 45); border-bottom-color: rgb(20 83 45);`,
			},
			{
				`border-y-green-950`,
				`border-top-color: rgb(5 46 22); border-bottom-color: rgb(5 46 22);`,
			},
			{
				`border-y-emerald-50`,
				`border-top-color: rgb(236 253 245); border-bottom-color: rgb(236 253 245);`,
			},
			{
				`border-y-emerald-100`,
				`border-top-color: rgb(209 250 229); border-bottom-color: rgb(209 250 229);`,
			},
			{
				`border-y-emerald-200`,
				`border-top-color: rgb(167 243 208); border-bottom-color: rgb(167 243 208);`,
			},
			{
				`border-y-emerald-300`,
				`border-top-color: rgb(110 231 183); border-bottom-color: rgb(110 231 183);`,
			},
			{
				`border-y-emerald-400`,
				`border-top-color: rgb(52 211 153); border-bottom-color: rgb(52 211 153);`,
			},
			{
				`border-y-emerald-500`,
				`border-top-color: rgb(16 185 129); border-bottom-color: rgb(16 185 129);`,
			},
			{
				`border-y-emerald-600`,
				`border-top-color: rgb(5 150 105); border-bottom-color: rgb(5 150 105);`,
			},
			{
				`border-y-emerald-700`,
				`border-top-color: rgb(4 120 87); border-bottom-color: rgb(4 120 87);`,
			},
			{
				`border-y-emerald-800`,
				`border-top-color: rgb(6 95 70); border-bottom-color: rgb(6 95 70);`,
			},
			{
				`border-y-emerald-900`,
				`border-top-color: rgb(6 78 59); border-bottom-color: rgb(6 78 59);`,
			},
			{
				`border-y-emerald-950`,
				`border-top-color: rgb(2 44 34); border-bottom-color: rgb(2 44 34);`,
			},
			{
				`border-y-teal-50`,
				`border-top-color: rgb(240 253 250); border-bottom-color: rgb(240 253 250);`,
			},
			{
				`border-y-teal-100`,
				`border-top-color: rgb(204 251 241); border-bottom-color: rgb(204 251 241);`,
			},
			{
				`border-y-teal-200`,
				`border-top-color: rgb(153 246 228); border-bottom-color: rgb(153 246 228);`,
			},
			{
				`border-y-teal-300`,
				`border-top-color: rgb(94 234 212); border-bottom-color: rgb(94 234 212);`,
			},
			{
				`border-y-teal-400`,
				`border-top-color: rgb(45 212 191); border-bottom-color: rgb(45 212 191);`,
			},
			{
				`border-y-teal-500`,
				`border-top-color: rgb(20 184 166); border-bottom-color: rgb(20 184 166);`,
			},
			{
				`border-y-teal-600`,
				`border-top-color: rgb(13 148 136); border-bottom-color: rgb(13 148 136);`,
			},
			{
				`border-y-teal-700`,
				`border-top-color: rgb(15 118 110); border-bottom-color: rgb(15 118 110);`,
			},
			{
				`border-y-teal-800`,
				`border-top-color: rgb(17 94 89); border-bottom-color: rgb(17 94 89);`,
			},
			{
				`border-y-teal-900`,
				`border-top-color: rgb(19 78 74); border-bottom-color: rgb(19 78 74);`,
			},
			{
				`border-y-teal-950`,
				`border-top-color: rgb(4 47 46); border-bottom-color: rgb(4 47 46);`,
			},
			{
				`border-y-cyan-50`,
			...
			{
				`border-y-cyan-100`,
				`border-top-color: rgb(207 250 254); border-bottom-color: rgb(207 250 254);`,
			},
			{
				`border-y-cyan-200`,
				`border-top-color: rgb(165 243 252); border-bottom-color: rgb(165 243 252);`,
			},
			{
				`border-y-cyan-300`,
				`border-top-color: rgb(103 232 249); border-bottom-color: rgb(103 232 249);`,
			},
			{
				`border-y-cyan-400`,
				`border-top-color: rgb(34 211 238); border-bottom-color: rgb(34 211 238);`,
			},
			{
				`border-y-cyan-500`,
				`border-top-color: rgb(6 182 212); border-bottom-color: rgb(6 182 212);`,
			},
			{
				`border-y-cyan-600`,
				`border-top-color: rgb(8 145 178); border-bottom-color: rgb(8 145 178);`,
			},
			{
				`border-y-cyan-700`,
				`border-top-color: rgb(14 116 144); border-bottom-color: rgb(14 116 144);`,
			},
			{
				`border-y-cyan-800`,
				`border-top-color: rgb(21 94 117); border-bottom-color: rgb(21 94 117);`,
			},
			{
				`border-y-cyan-900`,
				`border-top-color: rgb(22 78 99); border-bottom-color: rgb(22 78 99);`,
			},
			{
				`border-y-cyan-950`,
				`border-top-color: rgb(8 51 68); border-bottom-color: rgb(8 51 68);`,
			},
			{
				`border-y-sky-50`,
				`border-top-color: rgb(240 249 255); border-bottom-color: rgb(240 249 255);`,
			},
			{
				`border-y-sky-100`,
				`border-top-color: rgb(224 242 254); border-bottom-color: rgb(224 242 254);`,
			},
			{
				`border-y-sky-200`,
				`border-top-color: rgb(186 230 253); border-bottom-color: rgb(186 230 253);`,
			},
			{
				`border-y-sky-300`,
				`border-top-color: rgb(125 211 252); border-bottom-color: rgb(125 211 252);`,
			},
			{
				`border-y-sky-400`,
				`border-top-color: rgb(56 189 248); border-bottom-color: rgb(56 189 248);`,
			},
			{
				`border-y-sky-500`,
				`border-top-color: rgb(14 165 233); border-bottom-color: rgb(14 165 233);`,
			},
			{
				`border-y-sky-600`,
				`border-top-color: rgb(2 132 199); border-bottom-color: rgb(2 132 199);`,
			},
			{
				`border-y-sky-700`,
				`border-top-color: rgb(3 105 161); border-bottom-color: rgb(3 105 161);`,
			},
			{
				`border-y-sky-800`,
				`border-top-color: rgb(7 89 133); border-bottom-color: rgb(7 89 133);`,
			},
			{
				`border-y-sky-900`,
				`border-top-color: rgb(12 74 110); border-bottom-color: rgb(12 74 110);`,
			},
			{
				`border-y-sky-950`,
				`border-top-color: rgb(8 47 73); border-bottom-color: rgb(8 47 73);`,
			},
			{
				`border-y-blue-50`,
				`border-top-color: rgb(239 246 255); border-bottom-color: rgb(239 246 255);`,
			},
			{
				`border-y-blue-100`,
				`border-top-color: rgb(219 234 254); border-bottom-color: rgb(219 234 254);`,
			},
			{
				`border-y-blue-200`,
				`border-top-color: rgb(191 219 254); border-bottom-color: rgb(191 219 254);`,
			},
			{
				`border-y-blue-300`,
				`border-top-color: rgb(147 197 253); border-bottom-color: rgb(147 197 253);`,
			},
			{
				`border-y-blue-400`,
				`border-top-color: rgb(96 165 250); border-bottom-color: rgb(96 165 250);`,
			},
			{
				`border-y-blue-500`,
				`border-top-color: rgb(59 130 246); border-bottom-color: rgb(59 130 246);`,
			},
			{
				`border-y-blue-600`,
				`border-top-color: rgb(37 99 235); border-bottom-color: rgb(37 99 235);`,
			},
			{
				`border-y-blue-700`,
				`border-top-color: rgb(29 78 216); border-bottom-color: rgb(29 78 216);`,
			},
			{
				`border-y-blue-800`,
				`border-top-color: rgb(30 64 175); border-bottom-color: rgb(30 64 175);`,
			},
			{
				`border-y-blue-900`,
				`border-top-color: rgb(30 58 138); border-bottom-color: rgb(30 58 138);`,
			},
			{
				`border-y-blue-950`,
				`border-top-color: rgb(23 37 84); border-bottom-color: rgb(23 37 84);`,
			},
			{
				`border-y-indigo-50`,
				`border-top-color: rgb(238 242 255); border-bottom-color: rgb(238 242 255);`,
			},
			{
				`border-y-indigo-100`,
				`border-top-color: rgb(224 231 255); border-bottom-color: rgb(224 231 255);`,
			},
			{
				`border-y-indigo-200`,
				`border-top-color: rgb(199 210 254); border-bottom-color: rgb(199 210 254);`,
			},
			{
				`border-y-indigo-300`,
				`border-top-color: rgb(165 180 252); border-bottom-color: rgb(165 180 252);`,
			},
			{
				`border-y-indigo-400`,
				`border-top-color: rgb(129 140 248); border-bottom-color: rgb(129 140 248);`,
			},
			{
				`border-y-indigo-500`,
				`border-top-color: rgb(99 102 241); border-bottom-color: rgb(99 102 241);`,
			},
			{
				`border-y-indigo-600`,
				`border-top-color: rgb(79 70 229); border-bottom-color: rgb(79 70 229);`,
			},
			{
				`border-y-indigo-700`,
				`border-top-color: rgb(67 56 202); border-bottom-color: rgb(67 56 202);`,
			},
			{
				`border-y-indigo-800`,
				`border-top-color: rgb(55 48 163); border-bottom-color: rgb(55 48 163);`,
			},
			{
				`border-y-indigo-900`,
				`border-top-color: rgb(49 46 129); border-bottom-color: rgb(49 46 129);`,
			},
			{
				`border-y-indigo-950`,
				`border-top-color: rgb(30 27 75); border-bottom-color: rgb(30 27 75);`,
			},
			{
				`border-y-violet-50`,
				`border-top-color: rgb(245 243 255); border-bottom-color: rgb(245 243 255);`,
			},
			{
				`border-y-violet-100`,
				`border-top-color: rgb(237 233 254); border-bottom-color: rgb(237 233 254);`,
			},
			{
				`border-y-violet-200`,
				`border-top-color: rgb(221 214 254); border-bottom-color: rgb(221 214 254);`,
			},
			{
				`border-y-violet-300`,
				`border-top-color: rgb(196 181 253); border-bottom-color: rgb(196 181 253);`,
			},
			{
				`border-y-violet-400`,
				`border-top-color: rgb(167 139 250); border-bottom-color: rgb(167 139 250);`,
			},
			{
				`border-y-violet-500`,
				`border-top-color: rgb(139 92 246); border-bottom-color: rgb(139 92 246);`,
			},
			{
				`border-y-violet-600`,
				`border-top-color: rgb(124 58 237); border-bottom-color: rgb(124 58 237);`,
			},
			{
				`border-y-violet-700`,
				`border-top-color: rgb(109 40 217); border-bottom-color: rgb(109 40 217);`,
			},
			{
				`border-y-violet-800`,
				`border-top-color: rgb(91 33 182); border-bottom-color: rgb(91 33 182);`,
			},
			{
				`border-y-violet-900`,
				`border-top-color: rgb(76 29 149); border-bottom-color: rgb(76 29 149);`,
			},
			{
				`border-y-violet-950`,
				`border-top-color: rgb(46 16 101); border-bottom-color: rgb(46 16 101);`,
			},
			{
				`border-y-purple-50`,
				`border-top-color: rgb(250 245 255); border-bottom-color: rgb(250 245 255);`,
			},
			{
				`border-y-purple-100`,
				`border-top-color: rgb(243 232 255); border-bottom-color: rgb(243 232 255);`,
			},
			{
				`border-y-purple-200`,
				`border-top-color: rgb(233 213 255); border-bottom-color: rgb(233 213 255);`,
			},
			{
				`border-y-purple-300`,
				`border-top-color: rgb(216 180 254); border-bottom-color: rgb(216 180 254);`,
			},
			{
				`border-y-purple-400`,
				`border-top-color: rgb(192 132 252); border-bottom-color: rgb(192 132 252);`,
			},
			{
				`border-y-purple-500`,
				`border-top-color: rgb(168 85 247); border-bottom-color: rgb(168 85 247);`,
			},
			{
				`border-y-purple-600`,
				`border-top-color: rgb(147 51 234); border-bottom-color: rgb(147 51 234);`,
			},
			{
				`border-y-purple-700`,
				`border-top-color: rgb(126 34 206); border-bottom-color: rgb(126 34 206);`,
			},
			{
				`border-y-purple-800`,
				`border-top-color: rgb(107 33 168); border-bottom-color: rgb(107 33 168);`,
			},
			{
				`border-y-purple-900`,
				`border-top-color: rgb(88 28 135); border-bottom-color: rgb(88 28 135);`,
			},
			{
				`border-y-purple-950`,
				`border-top-color: rgb(59 7 100); border-bottom-color: rgb(59 7 100);`,
			},
			{
				`border-y-fuchsia-50`,
				`border-top-color: rgb(253 244 255); border-bottom-color: rgb(253 244 255);`,
			},
			{
				`border-y-fuchsia-100`,
				`border-top-color: rgb(250 232 255); border-bottom-color: rgb(250 232 255);`,
			},
			{
				`border-y-fuchsia-200`,
				`border-top-color: rgb(245 208 254); border-bottom-color: rgb(245 208 254);`,
			},
			{
				`border-y-fuchsia-300`,
				`border-top-color: rgb(240 171 252); border-bottom-color: rgb(240 171 252);`,
			},
			{
				`border-y-fuchsia-400`,
				`border-top-color: rgb(232 121 249); border-bottom-color: rgb(232 121 249);`,
			},
			{
				`border-y-fuchsia-500`,
				`border-top-color: rgb(217 70 239); border-bottom-color: rgb(217 70 239);`,
			},
			{
				`border-y-fuchsia-600`,
				`border-top-color: rgb(192 38 211); border-bottom-color: rgb(192 38 211);`,
			},
			{
				`border-y-fuchsia-700`,
				`border-top-color: rgb(162 28 175); border-bottom-color: rgb(162 28 175);`,
			},
			{
				`border-y-fuchsia-800`,
				`border-top-color: rgb(134 25 143); border-bottom-color: rgb(134 25 143);`,
			},
			{
				`border-y-fuchsia-900`,
				`border-top-color: rgb(112 26 117); border-bottom-color: rgb(112 26 117);`,
			},
			{
				`border-y-fuchsia-950`,
				`border-top-color: rgb(74 4 78); border-bottom-color: rgb(74 4 78);`,
			},
			{
				`border-y-pink-50`,
				`border-top-color: rgb(253 242 248); border-bottom-color: rgb(253 242 248);`,
			},
			{
				`border-y-pink-100`,
				`border-top-color: rgb(252 231 243); border-bottom-color: rgb(252 231 243);`,
			},
			{
				`border-y-pink-200`,
				`border-top-color: rgb(251 207 232); border-bottom-color: rgb(251 207 232);`,
			},
			{
				`border-y-pink-300`,
				`border-top-color: rgb(249 168 212); border-bottom-color: rgb(249 168 212);`,
			},
			{
				`border-y-pink-400`,
				`border-top-color: rgb(244 114 182); border-bottom-color: rgb(244 114 182);`,
			},
			{
				`border-y-pink-500`,
				`border-top-color: rgb(236 72 153); border-bottom-color: rgb(236 72 153);`,
			},
			{
				`border-y-pink-600`,
				`border-top-color: rgb(219 39 119); border-bottom-color: rgb(219 39 119);`,
			},
			{
				`border-y-pink-700`,
				`border-top-color: rgb(190 24 93); border-bottom-color: rgb(190 24 93);`,
			},
			{
				`border-y-pink-800`,
				`border-top-color: rgb(157 23 77); border-bottom-color: rgb(157 23 77);`,
			},
			{
				`border-y-pink-900`,
				`border-top-color: rgb(131 24 67); border-bottom-color: rgb(131 24 67);`,
			},
			{
				`border-y-pink-950`,
				`border-top-color: rgb(80 7 36); border-bottom-color: rgb(80 7 36);`,
			},
			{
				`border-y-rose-50`,
				`border-top-color: rgb(255 241 242); border-bottom-color: rgb(255 241 242);`,
			},
			{
				`border-y-rose-100`,
				`border-top-color: rgb(255 228 230); border-bottom-color: rgb(255 228 230);`,
			},
			{
				`border-y-rose-200`,
				`border-top-color: rgb(254 205 211); border-bottom-color: rgb(254 205 211);`,
			},
			{
				`border-y-rose-300`,
				`border-top-color: rgb(253 164 175); border-bottom-color: rgb(253 164 175);`,
			},
			{
				`border-y-rose-400`,
				`border-top-color: rgb(251 113 133); border-bottom-color: rgb(251 113 133);`,
			},
			{
				`border-y-rose-500`,
				`border-top-color: rgb(244 63 94); border-bottom-color: rgb(244 63 94);`,
			},
			{
				`border-y-rose-600`,
				`border-top-color: rgb(225 29 72); border-bottom-color: rgb(225 29 72);`,
			},
			{
				`border-y-rose-700`,
			...
			{
				`border-y-rose-800`,
				`border-top-color: rgb(159 18 57); border-bottom-color: rgb(159 18 57);`,
			},
			{
				`border-y-rose-900`,
				`border-top-color: rgb(136 19 55); border-bottom-color: rgb(136 19 55);`,
			},
			{
				`border-y-rose-950`,
				`border-top-color: rgb(76 5 25); border-bottom-color: rgb(76 5 25);`,
			},
	...
	},
	{
		...
		Description: "Utilidades para controlar el estilo de los bordes de un elemento.",
	...
	{
		Section:     "Borders",
		Subsection:  "Divide Width",
		Description: "Utilidades para controlar la anchura de los bordes entre elementos.",
	...
	{
		Section:     "Borders",
		Subsection:  "Divide Color",
		Description: "Utilidades para controlar el color de los bordes entre elementos.",
	...
	{
		Section:     "Borders",
		Subsection:  "Divide Style",
		Description: "Utilidades para controlar el estilo de los bordes entre elementos.",
	...
	{
		Section:     "Borders",
		Subsection:  "Outline Width",
		Description: "Utilidades para controlar la anchura del contorno de un elemento.",
	...
	{
		Section:     "Borders",
		Subsection:  "Outline Style",
		Description: "Utilidades para controlar el estilo del contorno de un elemento.",
	...
	{
		Section:     "Borders",
		Subsection:  "Outline Offset",
		Description: "Utilidades para controlar el desplazamiento del contorno de un elemento.",
	...
	{
		Section:     "Borders",
		Subsection:  "Ring Width",
		Description: "Utilidades para crear anillos de contorno con sombras de caja.",
	...
	{
		Section:     "Borders",
		Subsection:  "Ring Color",
		Description: "Utilidades para definir el color de los anillos de contorno.",
	...
	{
		Section:     "Borders",
		Subsection:  "Ring Offset Width",
		Description: "Utilidades para simular un desplazamiento al añadir anillos de contorno.",
	...
	},
	{
		...
		Body: [][]string{
			...
			},
			{
				...
				`--tw-ring-offset-color: #f1f5f9; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-slate-200`,
				`--tw-ring-offset-color: #e2e8f0; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-slate-300`,
				`--tw-ring-offset-color: #cbd5e1; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-slate-400`,
				`--tw-ring-offset-color: #94a3b8; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-slate-500`,
				`--tw-ring-offset-color: #64748b; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-slate-600`,
				`--tw-ring-offset-color: #475569; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-slate-700`,
				`--tw-ring-offset-color: #334155; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-slate-800`,
				`--tw-ring-offset-color: #1e293b; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-slate-900`,
				`--tw-ring-offset-color: #0f172a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-slate-950`,
				`--tw-ring-offset-color: #020617; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-50`,
				`--tw-ring-offset-color: #f9fafb; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-100`,
				`--tw-ring-offset-color: #f3f4f6; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-200`,
				`--tw-ring-offset-color: #e5e7eb; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-300`,
				`--tw-ring-offset-color: #d1d5db; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-400`,
				`--tw-ring-offset-color: #9ca3af; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-500`,
				`--tw-ring-offset-color: #6b7280; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-600`,
				`--tw-ring-offset-color: #4b5563; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-700`,
				`--tw-ring-offset-color: #374151; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-800`,
				`--tw-ring-offset-color: #1f2937; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-900`,
				`--tw-ring-offset-color: #111827; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-gray-950`,
				`--tw-ring-offset-color: #030712; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-50`,
				`--tw-ring-offset-color: #fafafa; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-100`,
				`--tw-ring-offset-color: #f4f4f5; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-200`,
				`--tw-ring-offset-color: #e4e4e7; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-300`,
				`--tw-ring-offset-color: #d4d4d8; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-400`,
				`--tw-ring-offset-color: #a1a1aa; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-500`,
				`--tw-ring-offset-color: #71717a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-600`,
				`--tw-ring-offset-color: #52525b; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-700`,
				`--tw-ring-offset-color: #3f3f46; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-800`,
				`--tw-ring-offset-color: #27272a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-900`,
				`--tw-ring-offset-color: #18181b; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-zinc-950`,
				`--tw-ring-offset-color: #09090b; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
			...
			},
			{
				...
				`--tw-ring-offset-color: #f5f5f5; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-neutral-200`,
				`--tw-ring-offset-color: #e5e5e5; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-neutral-300`,
				`--tw-ring-offset-color: #d4d4d4; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-neutral-400`,
				`--tw-ring-offset-color: #a3a3a3; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-neutral-500`,
				`--tw-ring-offset-color: #737373; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-neutral-600`,
				`--tw-ring-offset-color: #525252; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-neutral-700`,
				`--tw-ring-offset-color: #404040; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-neutral-800`,
				`--tw-ring-offset-color: #262626; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-neutral-900`,
				`--tw-ring-offset-color: #171717; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-neutral-950`,
				`--tw-ring-offset-color: #0a0a0a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-50`,
				`--tw-ring-offset-color: #fafaf9; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-100`,
				`--tw-ring-offset-color: #f5f5f4; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-200`,
				`--tw-ring-offset-color: #e7e5e4; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-300`,
				`--tw-ring-offset-color: #d6d3d1; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-400`,
				`--tw-ring-offset-color: #a8a29e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-500`,
				`--tw-ring-offset-color: #78716c; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-600`,
				`--tw-ring-offset-color: #57534e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-700`,
				`--tw-ring-offset-color: #44403c; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-800`,
				`--tw-ring-offset-color: #292524; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-900`,
				`--tw-ring-offset-color: #1c1917; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-stone-950`,
				`--tw-ring-offset-color: #0c0a09; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-50`,
				`--tw-ring-offset-color: #fef2f2; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-100`,
				`--tw-ring-offset-color: #fee2e2; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-200`,
				`--tw-ring-offset-color: #fecaca; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-300`,
				`--tw-ring-offset-color: #fca5a5; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-400`,
				`--tw-ring-offset-color: #f87171; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-500`,
				`--tw-ring-offset-color: #ef4444; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-600`,
				`--tw-ring-offset-color: #dc2626; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-700`,
				`--tw-ring-offset-color: #b91c1c; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-800`,
				`--tw-ring-offset-color: #991b1b; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-900`,
				`--tw-ring-offset-color: #7f1d1d; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-red-950`,
				`--tw-ring-offset-color: #450a0a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-50`,
				`--tw-ring-offset-color: #fff7ed; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-100`,
				`--tw-ring-offset-color: #ffedd5; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-200`,
				`--tw-ring-offset-color: #fed7aa; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-300`,
				`--tw-ring-offset-color: #fdba74; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-400`,
				`--tw-ring-offset-color: #fb923c; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-500`,
				`--tw-ring-offset-color: #f97316; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-600`,
				`--tw-ring-offset-color: #ea580c; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-700`,
				`--tw-ring-offset-color: #c2410c; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-800`,
				`--tw-ring-offset-color: #9a3412; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-900`,
				`--tw-ring-offset-color: #7c2d12; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-orange-950`,
				`--tw-ring-offset-color: #431407; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-50`,
				`--tw-ring-offset-color: #fffbeb; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-100`,
				`--tw-ring-offset-color: #fef3c7; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-200`,
				`--tw-ring-offset-color: #fde68a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-300`,
				`--tw-ring-offset-color: #fcd34d; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-400`,
				`--tw-ring-offset-color: #fbbf24; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-500`,
				`--tw-ring-offset-color: #f59e0b; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-600`,
				`--tw-ring-offset-color: #d97706; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-700`,
				`--tw-ring-offset-color: #b45309; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-800`,
				`--tw-ring-offset-color: #92400e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-900`,
				`--tw-ring-offset-color: #78350f; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-amber-950`,
				`--tw-ring-offset-color: #451a03; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-50`,
				`--tw-ring-offset-color: #fefce8; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-100`,
				`--tw-ring-offset-color: #fef9c3; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-200`,
				`--tw-ring-offset-color: #fef08a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-300`,
				`--tw-ring-offset-color: #fde047; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-400`,
				`--tw-ring-offset-color: #facc15; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-500`,
				`--tw-ring-offset-color: #eab308; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-600`,
				`--tw-ring-offset-color: #ca8a04; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-700`,
				`--tw-ring-offset-color: #a16207; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-800`,
				`--tw-ring-offset-color: #854d0e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-900`,
				`--tw-ring-offset-color: #713f12; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-yellow-950`,
				`--tw-ring-offset-color: #422006; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-50`,
				`--tw-ring-offset-color: #f7fee7; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-100`,
				`--tw-ring-offset-color: #ecfccb; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-200`,
				`--tw-ring-offset-color: #d9f99d; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-300`,
				`--tw-ring-offset-color: #bef264; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-400`,
				`--tw-ring-offset-color: #a3e635; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-500`,
				`--tw-ring-offset-color: #84cc16; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-600`,
				`--tw-ring-offset-color: #65a30d; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-700`,
				`--tw-ring-offset-color: #4d7c0f; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-800`,
				`--tw-ring-offset-color: #3f6212; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-900`,
				`--tw-ring-offset-color: #365314; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-lime-950`,
				`--tw-ring-offset-color: #1a2e05; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-50`,
				`--tw-ring-offset-color: #f0fdf4; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-100`,
				`--tw-ring-offset-color: #dcfce7; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-200`,
				`--tw-ring-offset-color: #bbf7d0; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-300`,
				`--tw-ring-offset-color: #86efac; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-400`,
				`--tw-ring-offset-color: #4ade80; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-500`,
				`--tw-ring-offset-color: #22c55e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-600`,
				`--tw-ring-offset-color: #16a34a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-700`,
				`--tw-ring-offset-color: #15803d; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-800`,
				`--tw-ring-offset-color: #166534; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-900`,
				`--tw-ring-offset-color: #14532d; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-green-950`,
				`--tw-ring-offset-color: #052e16; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-50`,
				`--tw-ring-offset-color: #ecfdf5; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-100`,
				`--tw-ring-offset-color: #d1fae5; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-200`,
				`--tw-ring-offset-color: #a7f3d0; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-300`,
				`--tw-ring-offset-color: #6ee7b7; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-400`,
				`--tw-ring-offset-color: #34d399; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-500`,
				`--tw-ring-offset-color: #10b981; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-600`,
				`--tw-ring-offset-color: #059669; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-700`,
				`--tw-ring-offset-color: #047857; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-800`,
				`--tw-ring-offset-color: #065f46; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-900`,
				`--tw-ring-offset-color: #064e3b; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-emerald-950`,
				`--tw-ring-offset-color: #022c22; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-50`,
				`--tw-ring-offset-color: #f0fdfa; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-100`,
				`--tw-ring-offset-color: #ccfbf1; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-200`,
				`--tw-ring-offset-color: #99f6e4; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-300`,
				`--tw-ring-offset-color: #5eead4; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-400`,
				`--tw-ring-offset-color: #2dd4bf; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-500`,
				`--tw-ring-offset-color: #14b8a6; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-600`,
				`--tw-ring-offset-color: #0d9488; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-700`,
				`--tw-ring-offset-color: #0f766e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-800`,
				`--tw-ring-offset-color: #115e59; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-900`,
				`--tw-ring-offset-color: #134e4a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-teal-950`,
				`--tw-ring-offset-color: #042f2e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-50`,
				`--tw-ring-offset-color: #ecfeff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-100`,
				`--tw-ring-offset-color: #cffafe; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-200`,
				`--tw-ring-offset-color: #a5f3fc; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-300`,
				`--tw-ring-offset-color: #67e8f9; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-400`,
				`--tw-ring-offset-color: #22d3ee; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-500`,
				`--tw-ring-offset-color: #06b6d4; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-600`,
				`--tw-ring-offset-color: #0891b2; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-700`,
				`--tw-ring-offset-color: #0e7490; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-800`,
				`--tw-ring-offset-color: #155e75; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-900`,
				`--tw-ring-offset-color: #164e63; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-cyan-950`,
				`--tw-ring-offset-color: #083344; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-50`,
				`--tw-ring-offset-color: #f0f9ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-100`,
				`--tw-ring-offset-color: #e0f2fe; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-200`,
				`--tw-ring-offset-color: #bae6fd; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-300`,
				`--tw-ring-offset-color: #7dd3fc; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-400`,
				`--tw-ring-offset-color: #38bdf8; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-500`,
				`--tw-ring-offset-color: #0ea5e9; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-600`,
				`--tw-ring-offset-color: #0284c7; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-700`,
				`--tw-ring-offset-color: #0369a1; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-800`,
				`--tw-ring-offset-color: #075985; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-900`,
				`--tw-ring-offset-color: #0c4a6e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-sky-950`,
				`--tw-ring-offset-color: #082f49; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-50`,
				`--tw-ring-offset-color: #eff6ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-100`,
				`--tw-ring-offset-color: #dbeafe; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-200`,
				`--tw-ring-offset-color: #bfdbfe; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-300`,
				`--tw-ring-offset-color: #93c5fd; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-400`,
				`--tw-ring-offset-color: #60a5fa; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-500`,
				`--tw-ring-offset-color: #3b82f6; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-600`,
				`--tw-ring-offset-color: #2563eb; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-700`,
				`--tw-ring-offset-color: #1d4ed8; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-800`,
				`--tw-ring-offset-color: #1e40af; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-900`,
				`--tw-ring-offset-color: #1e3a8a; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-blue-950`,
				`--tw-ring-offset-color: #172554; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-50`,
				`--tw-ring-offset-color: #eef2ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-100`,
				`--tw-ring-offset-color: #e0e7ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-200`,
				`--tw-ring-offset-color: #c7d2fe; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-300`,
				`--tw-ring-offset-color: #a5b4fc; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-400`,
				`--tw-ring-offset-color: #818cf8; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-500`,
				`--tw-ring-offset-color: #6366f1; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-600`,
				`--tw-ring-offset-color: #4f46e5; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-700`,
				`--tw-ring-offset-color: #4338ca; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-800`,
				`--tw-ring-offset-color: #3730a3; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-900`,
				`--tw-ring-offset-color: #312e81; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-indigo-950`,
				`--tw-ring-offset-color: #1e1b4b; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-50`,
				`--tw-ring-offset-color: #f5f3ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-100`,
				`--tw-ring-offset-color: #ede9fe; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-200`,
				`--tw-ring-offset-color: #ddd6fe; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-300`,
				`--tw-ring-offset-color: #c4b5fd; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-400`,
				`--tw-ring-offset-color: #a78bfa; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-500`,
				`--tw-ring-offset-color: #8b5cf6; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-600`,
				`--tw-ring-offset-color: #7c3aed; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-700`,
				`--tw-ring-offset-color: #6d28d9; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-800`,
				`--tw-ring-offset-color: #5b21b6; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-900`,
				`--tw-ring-offset-color: #4c1d95; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-violet-950`,
				`--tw-ring-offset-color: #2e1065; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-50`,
				`--tw-ring-offset-color: #faf5ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-100`,
				`--tw-ring-offset-color: #f3e8ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-200`,
				`--tw-ring-offset-color: #e9d5ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-300`,
				`--tw-ring-offset-color: #d8b4fe; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-400`,
				`--tw-ring-offset-color: #c084fc; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-500`,
				`--tw-ring-offset-color: #a855f7; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-600`,
				`--tw-ring-offset-color: #9333ea; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-700`,
				`--tw-ring-offset-color: #7e22ce; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-800`,
				`--tw-ring-offset-color: #6b21a8; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-900`,
				`--tw-ring-offset-color: #581c87; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-purple-950`,
				`--tw-ring-offset-color: #3b0764; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-50`,
				`--tw-ring-offset-color: #fdf4ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-100`,
				`--tw-ring-offset-color: #fae8ff; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-200`,
				`--tw-ring-offset-color: #f5d0fe; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-300`,
				`--tw-ring-offset-color: #f0abfc; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-400`,
				`--tw-ring-offset-color: #e879f9; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-500`,
				`--tw-ring-offset-color: #d946ef; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-600`,
				`--tw-ring-offset-color: #c026d3; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-700`,
				`--tw-ring-offset-color: #a21caf; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-800`,
				`--tw-ring-offset-color: #86198f; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-900`,
				`--tw-ring-offset-color: #701a75; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-fuchsia-950`,
				`--tw-ring-offset-color: #4a044e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-50`,
				`--tw-ring-offset-color: #fdf2f8; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-100`,
				`--tw-ring-offset-color: #fce7f3; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-200`,
				`--tw-ring-offset-color: #fbcfe8; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-300`,
				`--tw-ring-offset-color: #f9a8d4; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-400`,
				`--tw-ring-offset-color: #f472b6; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-500`,
				`--tw-ring-offset-color: #ec4899; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-600`,
				`--tw-ring-offset-color: #db2777; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-700`,
				`--tw-ring-offset-color: #be185d; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-800`,
				`--tw-ring-offset-color: #9d174d; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-900`,
				`--tw-ring-offset-color: #831843; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-pink-950`,
				`--tw-ring-offset-color: #500724; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-50`,
				`--tw-ring-offset-color: #fff1f2; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-100`,
				`--tw-ring-offset-color: #ffe4e6; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-200`,
				`--tw-ring-offset-color: #fecdd3; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-300`,
				`--tw-ring-offset-color: #fda4af; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-400`,
				`--tw-ring-offset-color: #fb7185; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-500`,
				`--tw-ring-offset-color: #f43f5e; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-600`,
				`--tw-ring-offset-color: #e11d48; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-700`,
				`--tw-ring-offset-color: #be123c; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-800`,
				`--tw-ring-offset-color: #9f1239; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-900`,
				`--tw-ring-offset-color: #881337; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
			{
				`ring-offset-rose-950`,
				`--tw-ring-offset-color: #4c0519; box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);`,
			},
		},
	},
	{
		Section:     "Sizing",
		Subsection:  "Width",
		Description: "Utilidades para definir la anchura de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para definir la anchura mínima de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para definir la anchura máxima de un elemento.",
	...
	},
	{
		Section:     "Sizing",
		Subsection:  "Height",
		Description: "Utilidades para definir la altura de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para definir la altura mínima de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para fijar la altura máxima de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la familia de fuentes de un elemento.",
		URL:         "https://tailwindcss.com/docs/fonts",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
			{
				`font-sans`,
	...
	},
	{
		...
		Description: "Utilidades para controlar el tamaño de letra de un elemento.",
		URL:         "https://tailwindcss.com/docs/text-sizing",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	{
		Section:     "Typography",
		Subsection:  "Font Smoothing",
		Description: "Utilidades para controlar el suavizado de la fuente de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el estilo del texto.",
		URL:         "https://tailwindcss.com/docs/text-style",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	},
	{
		...
		Description: "Utilidades para controlar el peso de la fuente de un elemento.",
	...
	{
		Section:     "Typography",
		Subsection:  "Font Variant Numeric",
		Description: "Utilidades para controlar la variante de los números.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el tracking (espaciado entre letras) de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el interlineado (altura de línea) de un elemento.",
	...
	{
		Section:     "Typography",
		Subsection:  "List Style Type",
		Description: "Utilidades para controlar el estilo de las viñetas/números de una lista.",
	...
	{
		Section:     "Typography",
		Subsection:  "List Style Position",
		Description: "Utilidades para controlar la posición de las viñetas/números en las listas.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la alineación del texto.",
		URL:         "https://tailwindcss.com/docs/text-alignment",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	},
	{
		...
		Description: "Utilidades para controlar el color del texto de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la decoración del texto.",
	...
	{
		Section:     "Typography",
		Subsection:  "Text Decoration Style",
		Description: "Utilidades para controlar el estilo de las decoraciones de texto.",
	...
	{
		Section:     "Typography",
		Subsection:  "Text Decoration Thickness",
		Description: "Utilidades para controlar el grosor de las decoraciones de texto.",
	...
	{
		Section:     "Typography",
		Subsection:  "Text Underline Offset",
		Description: "Utilidades para controlar el desplazamiento de un subrayado de texto.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la transformación del texto.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el desbordamiento del texto en un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la cantidad de espacio vacío que aparece antes del texto en un bloque.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la alineación vertical de una caja en línea o de celda de tabla.",
		URL:         "https://tailwindcss.com/docs/vertical-alignment",
		Header:      []string{`Class`, `Properties`},
		Body: [][]string{
	...
	},
	{
		...
		Description: "Utilidades para controlar la propiedad de espacio en blanco de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar los saltos de palabra en un elemento.",
	...
	},
	{
		Section:     "Typography",
		Subsection:  "Content",
		Description: "Utilidades para controlar el contenido de los pseudo-elementos antes y después.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el comportamiento de una imagen de fondo al desplazarse.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el cuadro delimitador del fondo de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la posición del fondo de un elemento en relación con los bordes, el relleno y el contenido.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la posición de la imagen de fondo de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la repetición de la imagen de fondo de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el tamaño de la imagen de fondo de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar la imagen de fondo de un elemento.",
	...
	{
		Section:     "Backgrounds",
		Subsection:  "Gradient Color Stops",
		Description: "Utilidades para controlar los topes de color en los degradados de fondo.",
		...
		Body: [][]string{
			...
			{
				`from-black`,
				`--tw-gradient-from: #000 var(--tw-gradient-from-position); --tw-gradient-to: rgb(0 0 0 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-white`,
				`--tw-gradient-from: #fff var(--tw-gradient-from-position); --tw-gradient-to: rgb(255 255 255 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-50`,
				`--tw-gradient-from: #f8fafc var(--tw-gradient-from-position); --tw-gradient-to: rgb(248 250 252 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-100`,
				`--tw-gradient-from: #f1f5f9 var(--tw-gradient-from-position); --tw-gradient-to: rgb(241 245 249 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-200`,
				`--tw-gradient-from: #e2e8f0 var(--tw-gradient-from-position); --tw-gradient-to: rgb(226 232 240 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-300`,
				`--tw-gradient-from: #cbd5e1 var(--tw-gradient-from-position); --tw-gradient-to: rgb(203 213 225 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-400`,
				`--tw-gradient-from: #94a3b8 var(--tw-gradient-from-position); --tw-gradient-to: rgb(148 163 184 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-500`,
				`--tw-gradient-from: #64748b var(--tw-gradient-from-position); --tw-gradient-to: rgb(100 116 139 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-600`,
				`--tw-gradient-from: #475569 var(--tw-gradient-from-position); --tw-gradient-to: rgb(71 85 105 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-700`,
				`--tw-gradient-from: #334155 var(--tw-gradient-from-position); --tw-gradient-to: rgb(51 65 85 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-800`,
				`--tw-gradient-from: #1e293b var(--tw-gradient-from-position); --tw-gradient-to: rgb(30 41 59 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-slate-900`,
			...
			{
				`from-slate-950`,
				`--tw-gradient-from: #020617 var(--tw-gradient-from-position); --tw-gradient-to: rgb(2 6 23 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-50`,
				`--tw-gradient-from: #f9fafb var(--tw-gradient-from-position); --tw-gradient-to: rgb(249 250 251 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-100`,
				`--tw-gradient-from: #f3f4f6 var(--tw-gradient-from-position); --tw-gradient-to: rgb(243 244 246 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-200`,
				`--tw-gradient-from: #e5e7eb var(--tw-gradient-from-position); --tw-gradient-to: rgb(229 231 235 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-300`,
				`--tw-gradient-from: #d1d5db var(--tw-gradient-from-position); --tw-gradient-to: rgb(209 213 219 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-400`,
				`--tw-gradient-from: #9ca3af var(--tw-gradient-from-position); --tw-gradient-to: rgb(156 163 175 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-500`,
				`--tw-gradient-from: #6b7280 var(--tw-gradient-from-position); --tw-gradient-to: rgb(107 114 128 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-600`,
				`--tw-gradient-from: #4b5563 var(--tw-gradient-from-position); --tw-gradient-to: rgb(75 85 99 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-700`,
				`--tw-gradient-from: #374151 var(--tw-gradient-from-position); --tw-gradient-to: rgb(55 65 81 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-800`,
				`--tw-gradient-from: #1f2937 var(--tw-gradient-from-position); --tw-gradient-to: rgb(31 41 55 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-900`,
				`--tw-gradient-from: #111827 var(--tw-gradient-from-position); --tw-gradient-to: rgb(17 24 39 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-gray-950`,
				`--tw-gradient-from: #030712 var(--tw-gradient-from-position); --tw-gradient-to: rgb(3 7 18 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-50`,
			...
			{
				`from-zinc-100`,
				`--tw-gradient-from: #f4f4f5 var(--tw-gradient-from-position); --tw-gradient-to: rgb(244 244 245 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-200`,
				`--tw-gradient-from: #e4e4e7 var(--tw-gradient-from-position); --tw-gradient-to: rgb(228 228 231 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-300`,
				`--tw-gradient-from: #d4d4d8 var(--tw-gradient-from-position); --tw-gradient-to: rgb(212 212 216 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-400`,
				`--tw-gradient-from: #a1a1aa var(--tw-gradient-from-position); --tw-gradient-to: rgb(161 161 170 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-500`,
				`--tw-gradient-from: #71717a var(--tw-gradient-from-position); --tw-gradient-to: rgb(113 113 122 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-600`,
				`--tw-gradient-from: #52525b var(--tw-gradient-from-position); --tw-gradient-to: rgb(82 82 91 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-700`,
				`--tw-gradient-from: #3f3f46 var(--tw-gradient-from-position); --tw-gradient-to: rgb(63 63 70 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-800`,
				`--tw-gradient-from: #27272a var(--tw-gradient-from-position); --tw-gradient-to: rgb(39 39 42 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-900`,
				`--tw-gradient-from: #18181b var(--tw-gradient-from-position); --tw-gradient-to: rgb(24 24 27 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-zinc-950`,
				`--tw-gradient-from: #09090b var(--tw-gradient-from-position); --tw-gradient-to: rgb(9 9 11 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-neutral-50`,
				`--tw-gradient-from: #fafafa var(--tw-gradient-from-position); --tw-gradient-to: rgb(250 250 250 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			...
			{
				`from-neutral-100`,
				`--tw-gradient-from: #f5f5f5 var(--tw-gradient-from-position); --tw-gradient-to: rgb(245 245 245 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-neutral-200`,
				`--tw-gradient-from: #e5e5e5 var(--tw-gradient-from-position); --tw-gradient-to: rgb(229 229 229 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-neutral-300`,
				`--tw-gradient-from: #d4d4d4 var(--tw-gradient-from-position); --tw-gradient-to: rgb(212 212 212 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-neutral-400`,
			...
			{
				`from-neutral-500`,
				`--tw-gradient-from: #737373 var(--tw-gradient-from-position); --tw-gradient-to: rgb(115 115 115 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-neutral-600`,
				`--tw-gradient-from: #525252 var(--tw-gradient-from-position); --tw-gradient-to: rgb(82 82 82 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-neutral-700`,
				`--tw-gradient-from: #404040 var(--tw-gradient-from-position); --tw-gradient-to: rgb(64 64 64 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-neutral-800`,
			...
			{
				`from-neutral-900`,
				`--tw-gradient-from: #171717 var(--tw-gradient-from-position); --tw-gradient-to: rgb(23 23 23 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-neutral-950`,
				`--tw-gradient-from: #0a0a0a var(--tw-gradient-from-position); --tw-gradient-to: rgb(10 10 10 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-50`,
				`--tw-gradient-from: #fafaf9 var(--tw-gradient-from-position); --tw-gradient-to: rgb(250 250 249 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-100`,
				`--tw-gradient-from: #f5f5f4 var(--tw-gradient-from-position); --tw-gradient-to: rgb(245 245 244 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-200`,
				`--tw-gradient-from: #e7e5e4 var(--tw-gradient-from-position); --tw-gradient-to: rgb(231 229 228 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-300`,
				`--tw-gradient-from: #d6d3d1 var(--tw-gradient-from-position); --tw-gradient-to: rgb(214 211 209 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-400`,
				`--tw-gradient-from: #a8a29e var(--tw-gradient-from-position); --tw-gradient-to: rgb(168 162 158 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-500`,
				`--tw-gradient-from: #78716c var(--tw-gradient-from-position); --tw-gradient-to: rgb(120 113 108 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-600`,
				`--tw-gradient-from: #57534e var(--tw-gradient-from-position); --tw-gradient-to: rgb(87 83 78 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-700`,
				`--tw-gradient-from: #44403c var(--tw-gradient-from-position); --tw-gradient-to: rgb(68 64 60 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-800`,
				`--tw-gradient-from: #292524 var(--tw-gradient-from-position); --tw-gradient-to: rgb(41 37 36 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-900`,
				`--tw-gradient-from: #1c1917 var(--tw-gradient-from-position); --tw-gradient-to: rgb(28 25 23 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-stone-950`,
				`--tw-gradient-from: #0c0a09 var(--tw-gradient-from-position); --tw-gradient-to: rgb(12 10 9 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-50`,
				`--tw-gradient-from: #fef2f2 var(--tw-gradient-from-position); --tw-gradient-to: rgb(254 242 242 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-100`,
				`--tw-gradient-from: #fee2e2 var(--tw-gradient-from-position); --tw-gradient-to: rgb(254 226 226 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-200`,
				`--tw-gradient-from: #fecaca var(--tw-gradient-from-position); --tw-gradient-to: rgb(254 202 202 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-300`,
				`--tw-gradient-from: #fca5a5 var(--tw-gradient-from-position); --tw-gradient-to: rgb(252 165 165 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-400`,
				`--tw-gradient-from: #f87171 var(--tw-gradient-from-position); --tw-gradient-to: rgb(248 113 113 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-500`,
				`--tw-gradient-from: #ef4444 var(--tw-gradient-from-position); --tw-gradient-to: rgb(239 68 68 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-600`,
				`--tw-gradient-from: #dc2626 var(--tw-gradient-from-position); --tw-gradient-to: rgb(220 38 38 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-700`,
				`--tw-gradient-from: #b91c1c var(--tw-gradient-from-position); --tw-gradient-to: rgb(185 28 28 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-800`,
				`--tw-gradient-from: #991b1b var(--tw-gradient-from-position); --tw-gradient-to: rgb(153 27 27 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-red-900`,
			...
			{
				`from-red-950`,
				`--tw-gradient-from: #450a0a var(--tw-gradient-from-position); --tw-gradient-to: rgb(69 10 10 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-50`,
				`--tw-gradient-from: #fff7ed var(--tw-gradient-from-position); --tw-gradient-to: rgb(255 247 237 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-100`,
				`--tw-gradient-from: #ffedd5 var(--tw-gradient-from-position); --tw-gradient-to: rgb(255 237 213 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-200`,
				`--tw-gradient-from: #fed7aa var(--tw-gradient-from-position); --tw-gradient-to: rgb(254 215 170 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-300`,
				`--tw-gradient-from: #fdba74 var(--tw-gradient-from-position); --tw-gradient-to: rgb(253 186 116 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-400`,
				`--tw-gradient-from: #fb923c var(--tw-gradient-from-position); --tw-gradient-to: rgb(251 146 60 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-500`,
				`--tw-gradient-from: #f97316 var(--tw-gradient-from-position); --tw-gradient-to: rgb(249 115 22 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-600`,
				`--tw-gradient-from: #ea580c var(--tw-gradient-from-position); --tw-gradient-to: rgb(234 88 12 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-700`,
				`--tw-gradient-from: #c2410c var(--tw-gradient-from-position); --tw-gradient-to: rgb(194 65 12 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-800`,
				`--tw-gradient-from: #9a3412 var(--tw-gradient-from-position); --tw-gradient-to: rgb(154 52 18 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-900`,
				`--tw-gradient-from: #7c2d12 var(--tw-gradient-from-position); --tw-gradient-to: rgb(124 45 18 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-orange-950`,
				`--tw-gradient-from: #431407 var(--tw-gradient-from-position); --tw-gradient-to: rgb(67 20 7 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-50`,
				`--tw-gradient-from: #fffbeb var(--tw-gradient-from-position); --tw-gradient-to: rgb(255 251 235 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-100`,
				`--tw-gradient-from: #fef3c7 var(--tw-gradient-from-position); --tw-gradient-to: rgb(254 243 199 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-200`,
				`--tw-gradient-from: #fde68a var(--tw-gradient-from-position); --tw-gradient-to: rgb(253 230 138 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-300`,
				`--tw-gradient-from: #fcd34d var(--tw-gradient-from-position); --tw-gradient-to: rgb(252 211 77 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-400`,
				`--tw-gradient-from: #fbbf24 var(--tw-gradient-from-position); --tw-gradient-to: rgb(251 191 36 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-500`,
				`--tw-gradient-from: #f59e0b var(--tw-gradient-from-position); --tw-gradient-to: rgb(245 158 11 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-600`,
				`--tw-gradient-from: #d97706 var(--tw-gradient-from-position); --tw-gradient-to: rgb(217 119 6 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-700`,
				`--tw-gradient-from: #b45309 var(--tw-gradient-from-position); --tw-gradient-to: rgb(180 83 9 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-800`,
				`--tw-gradient-from: #92400e var(--tw-gradient-from-position); --tw-gradient-to: rgb(146 64 14 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-900`,
				`--tw-gradient-from: #78350f var(--tw-gradient-from-position); --tw-gradient-to: rgb(120 53 15 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-amber-950`,
				`--tw-gradient-from: #451a03 var(--tw-gradient-from-position); --tw-gradient-to: rgb(69 26 3 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-50`,
				`--tw-gradient-from: #fefce8 var(--tw-gradient-from-position); --tw-gradient-to: rgb(254 252 232 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-100`,
				`--tw-gradient-from: #fef9c3 var(--tw-gradient-from-position); --tw-gradient-to: rgb(254 249 195 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-200`,
				`--tw-gradient-from: #fef08a var(--tw-gradient-from-position); --tw-gradient-to: rgb(254 240 138 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-300`,
				`--tw-gradient-from: #fde047 var(--tw-gradient-from-position); --tw-gradient-to: rgb(253 224 71 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-400`,
				`--tw-gradient-from: #facc15 var(--tw-gradient-from-position); --tw-gradient-to: rgb(250 204 21 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-500`,
				`--tw-gradient-from: #eab308 var(--tw-gradient-from-position); --tw-gradient-to: rgb(234 179 8 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-600`,
				`--tw-gradient-from: #ca8a04 var(--tw-gradient-from-position); --tw-gradient-to: rgb(202 138 4 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-700`,
				`--tw-gradient-from: #a16207 var(--tw-gradient-from-position); --tw-gradient-to: rgb(161 98 7 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-800`,
				`--tw-gradient-from: #854d0e var(--tw-gradient-from-position); --tw-gradient-to: rgb(133 77 14 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-900`,
				`--tw-gradient-from: #713f12 var(--tw-gradient-from-position); --tw-gradient-to: rgb(113 63 18 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-yellow-950`,
				`--tw-gradient-from: #422006 var(--tw-gradient-from-position); --tw-gradient-to: rgb(66 32 6 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-50`,
				`--tw-gradient-from: #f7fee7 var(--tw-gradient-from-position); --tw-gradient-to: rgb(247 254 231 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-100`,
				`--tw-gradient-from: #ecfccb var(--tw-gradient-from-position); --tw-gradient-to: rgb(236 252 203 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-200`,
				`--tw-gradient-from: #d9f99d var(--tw-gradient-from-position); --tw-gradient-to: rgb(217 249 157 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-300`,
				`--tw-gradient-from: #bef264 var(--tw-gradient-from-position); --tw-gradient-to: rgb(190 242 100 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-400`,
				`--tw-gradient-from: #a3e635 var(--tw-gradient-from-position); --tw-gradient-to: rgb(163 230 53 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-500`,
				`--tw-gradient-from: #84cc16 var(--tw-gradient-from-position); --tw-gradient-to: rgb(132 204 22 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-600`,
				`--tw-gradient-from: #65a30d var(--tw-gradient-from-position); --tw-gradient-to: rgb(101 163 13 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-700`,
				`--tw-gradient-from: #4d7c0f var(--tw-gradient-from-position); --tw-gradient-to: rgb(77 124 15 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-800`,
				`--tw-gradient-from: #3f6212 var(--tw-gradient-from-position); --tw-gradient-to: rgb(63 98 18 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-900`,
				`--tw-gradient-from: #365314 var(--tw-gradient-from-position); --tw-gradient-to: rgb(54 83 20 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-lime-950`,
				`--tw-gradient-from: #1a2e05 var(--tw-gradient-from-position); --tw-gradient-to: rgb(26 46 5 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-50`,
				`--tw-gradient-from: #f0fdf4 var(--tw-gradient-from-position); --tw-gradient-to: rgb(240 253 244 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-100`,
				`--tw-gradient-from: #dcfce7 var(--tw-gradient-from-position); --tw-gradient-to: rgb(220 252 231 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-200`,
				`--tw-gradient-from: #bbf7d0 var(--tw-gradient-from-position); --tw-gradient-to: rgb(187 247 208 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-300`,
				`--tw-gradient-from: #86efac var(--tw-gradient-from-position); --tw-gradient-to: rgb(134 239 172 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-400`,
				`--tw-gradient-from: #4ade80 var(--tw-gradient-from-position); --tw-gradient-to: rgb(74 222 128 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-500`,
				`--tw-gradient-from: #22c55e var(--tw-gradient-from-position); --tw-gradient-to: rgb(34 197 94 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-600`,
				`--tw-gradient-from: #16a34a var(--tw-gradient-from-position); --tw-gradient-to: rgb(22 163 74 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-700`,
				`--tw-gradient-from: #15803d var(--tw-gradient-from-position); --tw-gradient-to: rgb(21 128 61 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-800`,
				`--tw-gradient-from: #166534 var(--tw-gradient-from-position); --tw-gradient-to: rgb(22 101 52 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-900`,
				`--tw-gradient-from: #14532d var(--tw-gradient-from-position); --tw-gradient-to: rgb(20 83 45 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-green-950`,
				`--tw-gradient-from: #052e16 var(--tw-gradient-from-position); --tw-gradient-to: rgb(5 46 22 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-50`,
				`--tw-gradient-from: #ecfdf5 var(--tw-gradient-from-position); --tw-gradient-to: rgb(236 253 245 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-100`,
				`--tw-gradient-from: #d1fae5 var(--tw-gradient-from-position); --tw-gradient-to: rgb(209 250 229 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-200`,
				`--tw-gradient-from: #a7f3d0 var(--tw-gradient-from-position); --tw-gradient-to: rgb(167 243 208 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-300`,
				`--tw-gradient-from: #6ee7b7 var(--tw-gradient-from-position); --tw-gradient-to: rgb(110 231 183 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-400`,
				`--tw-gradient-from: #34d399 var(--tw-gradient-from-position); --tw-gradient-to: rgb(52 211 153 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-500`,
				`--tw-gradient-from: #10b981 var(--tw-gradient-from-position); --tw-gradient-to: rgb(16 185 129 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-600`,
				`--tw-gradient-from: #059669 var(--tw-gradient-from-position); --tw-gradient-to: rgb(5 150 105 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-700`,
				`--tw-gradient-from: #047857 var(--tw-gradient-from-position); --tw-gradient-to: rgb(4 120 87 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-800`,
				`--tw-gradient-from: #065f46 var(--tw-gradient-from-position); --tw-gradient-to: rgb(6 95 70 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-900`,
				`--tw-gradient-from: #064e3b var(--tw-gradient-from-position); --tw-gradient-to: rgb(6 78 59 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-emerald-950`,
				`--tw-gradient-from: #022c22 var(--tw-gradient-from-position); --tw-gradient-to: rgb(2 44 34 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-50`,
				`--tw-gradient-from: #f0fdfa var(--tw-gradient-from-position); --tw-gradient-to: rgb(240 253 250 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-100`,
				`--tw-gradient-from: #ccfbf1 var(--tw-gradient-from-position); --tw-gradient-to: rgb(204 251 241 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-200`,
				`--tw-gradient-from: #99f6e4 var(--tw-gradient-from-position); --tw-gradient-to: rgb(153 246 228 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-300`,
				`--tw-gradient-from: #5eead4 var(--tw-gradient-from-position); --tw-gradient-to: rgb(94 234 212 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-400`,
				`--tw-gradient-from: #2dd4bf var(--tw-gradient-from-position); --tw-gradient-to: rgb(45 212 191 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-500`,
				`--tw-gradient-from: #14b8a6 var(--tw-gradient-from-position); --tw-gradient-to: rgb(20 184 166 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-600`,
				`--tw-gradient-from: #0d9488 var(--tw-gradient-from-position); --tw-gradient-to: rgb(13 148 136 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-700`,
				`--tw-gradient-from: #0f766e var(--tw-gradient-from-position); --tw-gradient-to: rgb(15 118 110 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-800`,
				`--tw-gradient-from: #115e59 var(--tw-gradient-from-position); --tw-gradient-to: rgb(17 94 89 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-900`,
				`--tw-gradient-from: #134e4a var(--tw-gradient-from-position); --tw-gradient-to: rgb(19 78 74 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-teal-950`,
				`--tw-gradient-from: #042f2e var(--tw-gradient-from-position); --tw-gradient-to: rgb(4 47 46 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-cyan-50`,
				`--tw-gradient-from: #ecfeff var(--tw-gradient-from-position); --tw-gradient-to: rgb(236 254 255 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-cyan-100`,
				`--tw-gradient-from: #cffafe var(--tw-gradient-from-position); --tw-gradient-to: rgb(207 250 254 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-cyan-200`,
				`--tw-gradient-from: #a5f3fc var(--tw-gradient-from-position); --tw-gradient-to: rgb(165 243 252 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-cyan-300`,
				`--tw-gradient-from: #67e8f9 var(--tw-gradient-from-position); --tw-gradient-to: rgb(103 232 249 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-cyan-400`,
				`--tw-gradient-from: #22d3ee var(--tw-gradient-from-position); --tw-gradient-to: rgb(34 211 238 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-cyan-500`,
				`--tw-gradient-from: #06b6d4 var(--tw-gradient-from-position); --tw-gradient-to: rgb(6 182 212 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-cyan-600`,
			...
			{
				`from-blue-600`,
				`--tw-gradient-from: #2563eb var(--tw-gradient-from-position); --tw-gradient-to: rgb(37 99 235 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-blue-700`,
				`--tw-gradient-from: #1d4ed8 var(--tw-gradient-from-position); --tw-gradient-to: rgb(29 78 216 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-blue-800`,
				`--tw-gradient-from: #1e40af var(--tw-gradient-from-position); --tw-gradient-to: rgb(30 64 175 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-blue-900`,
				`--tw-gradient-from: #1e3a8a var(--tw-gradient-from-position); --tw-gradient-to: rgb(30 58 138 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-blue-950`,
				`--tw-gradient-from: #172554 var(--tw-gradient-from-position); --tw-gradient-to: rgb(23 37 84 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-50`,
				`--tw-gradient-from: #eef2ff var(--tw-gradient-from-position); --tw-gradient-to: rgb(238 242 255 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-100`,
				`--tw-gradient-from: #e0e7ff var(--tw-gradient-from-position); --tw-gradient-to: rgb(224 231 255 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-200`,
				`--tw-gradient-from: #c7d2fe var(--tw-gradient-from-position); --tw-gradient-to: rgb(199 210 254 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-300`,
				`--tw-gradient-from: #a5b4fc var(--tw-gradient-from-position); --tw-gradient-to: rgb(165 180 252 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-400`,
				`--tw-gradient-from: #818cf8 var(--tw-gradient-from-position); --tw-gradient-to: rgb(129 140 248 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-500`,
				`--tw-gradient-from: #6366f1 var(--tw-gradient-from-position); --tw-gradient-to: rgb(99 102 241 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-600`,
				`--tw-gradient-from: #4f46e5 var(--tw-gradient-from-position); --tw-gradient-to: rgb(79 70 229 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-700`,
				`--tw-gradient-from: #4338ca var(--tw-gradient-from-position); --tw-gradient-to: rgb(67 56 202 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-800`,
				`--tw-gradient-from: #3730a3 var(--tw-gradient-from-position); --tw-gradient-to: rgb(55 48 163 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-900`,
				`--tw-gradient-from: #312e81 var(--tw-gradient-from-position); --tw-gradient-to: rgb(49 46 129 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-indigo-950`,
				`--tw-gradient-from: #1e1b4b var(--tw-gradient-from-position); --tw-gradient-to: rgb(30 27 75 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-50`,
				`--tw-gradient-from: #f5f3ff var(--tw-gradient-from-position); --tw-gradient-to: rgb(245 243 255 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-100`,
				`--tw-gradient-from: #ede9fe var(--tw-gradient-from-position); --tw-gradient-to: rgb(237 233 254 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-200`,
				`--tw-gradient-from: #ddd6fe var(--tw-gradient-from-position); --tw-gradient-to: rgb(221 214 254 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-300`,
				`--tw-gradient-from: #c4b5fd var(--tw-gradient-from-position); --tw-gradient-to: rgb(196 181 253 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-400`,
				`--tw-gradient-from: #a78bfa var(--tw-gradient-from-position); --tw-gradient-to: rgb(167 139 250 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-500`,
				`--tw-gradient-from: #8b5cf6 var(--tw-gradient-from-position); --tw-gradient-to: rgb(139 92 246 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-600`,
				`--tw-gradient-from: #7c3aed var(--tw-gradient-from-position); --tw-gradient-to: rgb(124 58 237 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-700`,
				`--tw-gradient-from: #6d28d9 var(--tw-gradient-from-position); --tw-gradient-to: rgb(109 40 217 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-800`,
				`--tw-gradient-from: #5b21b6 var(--tw-gradient-from-position); --tw-gradient-to: rgb(91 33 182 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-900`,
				`--tw-gradient-from: #4c1d95 var(--tw-gradient-from-position); --tw-gradient-to: rgb(76 29 149 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-violet-950`,
				`--tw-gradient-from: #2e1065 var(--tw-gradient-from-position); --tw-gradient-to: rgb(46 16 101 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-50`,
			...
			{
				`from-purple-100`,
				`--tw-gradient-from: #f3e8ff var(--tw-gradient-from-position); --tw-gradient-to: rgb(243 232 255 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-200`,
				`--tw-gradient-from: #e9d5ff var(--tw-gradient-from-position); --tw-gradient-to: rgb(233 213 255 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-300`,
				`--tw-gradient-from: #d8b4fe var(--tw-gradient-from-position); --tw-gradient-to: rgb(216 180 254 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-400`,
				`--tw-gradient-from: #c084fc var(--tw-gradient-from-position); --tw-gradient-to: rgb(192 132 252 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-500`,
				`--tw-gradient-from: #a855f7 var(--tw-gradient-from-position); --tw-gradient-to: rgb(168 85 247 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-600`,
				`--tw-gradient-from: #9333ea var(--tw-gradient-from-position); --tw-gradient-to: rgb(147 51 234 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-700`,
				`--tw-gradient-from: #7e22ce var(--tw-gradient-from-position); --tw-gradient-to: rgb(126 34 206 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-800`,
				`--tw-gradient-from: #6b21a8 var(--tw-gradient-from-position); --tw-gradient-to: rgb(107 33 168 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-900`,
				`--tw-gradient-from: #581c87 var(--tw-gradient-from-position); --tw-gradient-to: rgb(88 28 135 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-purple-950`,
				`--tw-gradient-from: #3b0764 var(--tw-gradient-from-position); --tw-gradient-to: rgb(59 7 100 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-50`,
				`--tw-gradient-from: #fdf4ff var(--tw-gradient-from-position); --tw-gradient-to: rgb(253 244 255 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-100`,
				`--tw-gradient-from: #fae8ff var(--tw-gradient-from-position); --tw-gradient-to: rgb(250 232 255 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-200`,
				`--tw-gradient-from: #f5d0fe var(--tw-gradient-from-position); --tw-gradient-to: rgb(245 208 254 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-300`,
				`--tw-gradient-from: #f0abfc var(--tw-gradient-from-position); --tw-gradient-to: rgb(240 171 252 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-400`,
				`--tw-gradient-from: #e879f9 var(--tw-gradient-from-position); --tw-gradient-to: rgb(232 121 249 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-500`,
				`--tw-gradient-from: #d946ef var(--tw-gradient-from-position); --tw-gradient-to: rgb(217 70 239 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-600`,
				`--tw-gradient-from: #c026d3 var(--tw-gradient-from-position); --tw-gradient-to: rgb(192 38 211 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-700`,
				`--tw-gradient-from: #a21caf var(--tw-gradient-from-position); --tw-gradient-to: rgb(162 28 175 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-800`,
				`--tw-gradient-from: #86198f var(--tw-gradient-from-position); --tw-gradient-to: rgb(134 25 143 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-900`,
				`--tw-gradient-from: #701a75 var(--tw-gradient-from-position); --tw-gradient-to: rgb(112 26 117 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-fuchsia-950`,
				`--tw-gradient-from: #4a044e var(--tw-gradient-from-position); --tw-gradient-to: rgb(74 4 78 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-50`,
				`--tw-gradient-from: #fdf2f8 var(--tw-gradient-from-position); --tw-gradient-to: rgb(253 242 248 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-100`,
				`--tw-gradient-from: #fce7f3 var(--tw-gradient-from-position); --tw-gradient-to: rgb(252 231 243 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-200`,
				`--tw-gradient-from: #fbcfe8 var(--tw-gradient-from-position); --tw-gradient-to: rgb(251 207 232 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-300`,
				`--tw-gradient-from: #f9a8d4 var(--tw-gradient-from-position); --tw-gradient-to: rgb(249 168 212 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-400`,
				`--tw-gradient-from: #f472b6 var(--tw-gradient-from-position); --tw-gradient-to: rgb(244 114 182 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-500`,
				`--tw-gradient-from: #ec4899 var(--tw-gradient-from-position); --tw-gradient-to: rgb(236 72 153 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-600`,
				`--tw-gradient-from: #db2777 var(--tw-gradient-from-position); --tw-gradient-to: rgb(219 39 119 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-700`,
				`--tw-gradient-from: #be185d var(--tw-gradient-from-position); --tw-gradient-to: rgb(190 24 93 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-800`,
				`--tw-gradient-from: #9d174d var(--tw-gradient-from-position); --tw-gradient-to: rgb(157 23 77 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-900`,
				`--tw-gradient-from: #831843 var(--tw-gradient-from-position); --tw-gradient-to: rgb(131 24 67 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-pink-950`,
				`--tw-gradient-from: #500724 var(--tw-gradient-from-position); --tw-gradient-to: rgb(80 7 36 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-50`,
				`--tw-gradient-from: #fff1f2 var(--tw-gradient-from-position); --tw-gradient-to: rgb(255 241 242 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-100`,
				`--tw-gradient-from: #ffe4e6 var(--tw-gradient-from-position); --tw-gradient-to: rgb(255 228 230 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-200`,
				`--tw-gradient-from: #fecdd3 var(--tw-gradient-from-position); --tw-gradient-to: rgb(254 205 211 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-300`,
				`--tw-gradient-from: #fda4af var(--tw-gradient-from-position); --tw-gradient-to: rgb(253 164 175 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-400`,
				`--tw-gradient-from: #fb7185 var(--tw-gradient-from-position); --tw-gradient-to: rgb(251 113 133 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-500`,
				`--tw-gradient-from: #f43f5e var(--tw-gradient-from-position); --tw-gradient-to: rgb(244 63 94 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-600`,
				`--tw-gradient-from: #e11d48 var(--tw-gradient-from-position); --tw-gradient-to: rgb(225 29 72 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-700`,
				`--tw-gradient-from: #be123c var(--tw-gradient-from-position); --tw-gradient-to: rgb(190 18 60 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-800`,
				`--tw-gradient-from: #9f1239 var(--tw-gradient-from-position); --tw-gradient-to: rgb(159 18 57 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-900`,
				`--tw-gradient-from: #881337 var(--tw-gradient-from-position); --tw-gradient-to: rgb(136 19 55 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			{
				`from-rose-950`,
				`--tw-gradient-from: #4c0519 var(--tw-gradient-from-position); --tw-gradient-to: rgb(76 5 25 / 0) var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,
			},
			...
			{
				`via-black`,
				`--tw-gradient-to: rgb(0 0 0 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #000 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-white`,
				`--tw-gradient-to: rgb(255 255 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-50`,
				`--tw-gradient-to: rgb(248 250 252 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f8fafc var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-100`,
				`--tw-gradient-to: rgb(241 245 249 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f1f5f9 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-200`,
				`--tw-gradient-to: rgb(226 232 240 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #e2e8f0 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-300`,
				`--tw-gradient-to: rgb(203 213 225 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #cbd5e1 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-400`,
				`--tw-gradient-to: rgb(148 163 184 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #94a3b8 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-500`,
				`--tw-gradient-to: rgb(100 116 139 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #64748b var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-600`,
				`--tw-gradient-to: rgb(71 85 105 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #475569 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-700`,
				`--tw-gradient-to: rgb(51 65 85 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #334155 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-800`,
				`--tw-gradient-to: rgb(30 41 59 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #1e293b var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-900`,
				`--tw-gradient-to: rgb(15 23 42 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0f172a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-slate-950`,
				`--tw-gradient-to: rgb(2 6 23 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #020617 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-50`,
				`--tw-gradient-to: rgb(249 250 251 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f9fafb var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-100`,
				`--tw-gradient-to: rgb(243 244 246 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f3f4f6 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-200`,
				`--tw-gradient-to: rgb(229 231 235 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #e5e7eb var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-300`,
				`--tw-gradient-to: rgb(209 213 219 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #d1d5db var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-400`,
				`--tw-gradient-to: rgb(156 163 175 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #9ca3af var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-500`,
				`--tw-gradient-to: rgb(107 114 128 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #6b7280 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-600`,
				`--tw-gradient-to: rgb(75 85 99 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #4b5563 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-700`,
				`--tw-gradient-to: rgb(55 65 81 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #374151 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-800`,
				`--tw-gradient-to: rgb(31 41 55 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #1f2937 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-900`,
				`--tw-gradient-to: rgb(17 24 39 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #111827 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-gray-950`,
				`--tw-gradient-to: rgb(3 7 18 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #030712 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-50`,
				`--tw-gradient-to: rgb(250 250 250 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fafafa var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-100`,
				`--tw-gradient-to: rgb(244 244 245 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f4f4f5 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-200`,
				`--tw-gradient-to: rgb(228 228 231 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #e4e4e7 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-300`,
				`--tw-gradient-to: rgb(212 212 216 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #d4d4d8 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-400`,
				`--tw-gradient-to: rgb(161 161 170 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a1a1aa var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-500`,
				`--tw-gradient-to: rgb(113 113 122 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #71717a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-600`,
				`--tw-gradient-to: rgb(82 82 91 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #52525b var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-700`,
				`--tw-gradient-to: rgb(63 63 70 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #3f3f46 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-800`,
				`--tw-gradient-to: rgb(39 39 42 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #27272a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-900`,
				`--tw-gradient-to: rgb(24 24 27 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #18181b var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-zinc-950`,
				`--tw-gradient-to: rgb(9 9 11 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #09090b var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-neutral-50`,
				`--tw-gradient-to: rgb(250 250 250 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fafafa var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			...
			{
				`via-neutral-100`,
				`--tw-gradient-to: rgb(245 245 245 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f5f5f5 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-neutral-200`,
			...
			{
				`via-neutral-300`,
				`--tw-gradient-to: rgb(212 212 212 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #d4d4d4 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-neutral-400`,
				`--tw-gradient-to: rgb(163 163 163 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a3a3a3 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-neutral-500`,
				`--tw-gradient-to: rgb(115 115 115 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #737373 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-neutral-600`,
			...
			{
				`via-neutral-700`,
				`--tw-gradient-to: rgb(64 64 64 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #404040 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-neutral-800`,
				`--tw-gradient-to: rgb(38 38 38 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #262626 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-neutral-900`,
				`--tw-gradient-to: rgb(23 23 23 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #171717 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-neutral-950`,
				`--tw-gradient-to: rgb(10 10 10 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0a0a0a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-50`,
				`--tw-gradient-to: rgb(250 250 249 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fafaf9 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-100`,
				`--tw-gradient-to: rgb(245 245 244 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f5f5f4 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-200`,
				`--tw-gradient-to: rgb(231 229 228 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #e7e5e4 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-300`,
				`--tw-gradient-to: rgb(214 211 209 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #d6d3d1 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-400`,
				`--tw-gradient-to: rgb(168 162 158 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a8a29e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-500`,
				`--tw-gradient-to: rgb(120 113 108 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #78716c var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-600`,
				`--tw-gradient-to: rgb(87 83 78 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #57534e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-700`,
				`--tw-gradient-to: rgb(68 64 60 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #44403c var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-800`,
				`--tw-gradient-to: rgb(41 37 36 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #292524 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-900`,
				`--tw-gradient-to: rgb(28 25 23 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #1c1917 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-stone-950`,
				`--tw-gradient-to: rgb(12 10 9 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0c0a09 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-50`,
				`--tw-gradient-to: rgb(254 242 242 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fef2f2 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-100`,
				`--tw-gradient-to: rgb(254 226 226 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fee2e2 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-200`,
				`--tw-gradient-to: rgb(254 202 202 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fecaca var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-300`,
				`--tw-gradient-to: rgb(252 165 165 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fca5a5 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-400`,
				`--tw-gradient-to: rgb(248 113 113 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f87171 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-500`,
				`--tw-gradient-to: rgb(239 68 68 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ef4444 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-600`,
				`--tw-gradient-to: rgb(220 38 38 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #dc2626 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-700`,
				`--tw-gradient-to: rgb(185 28 28 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #b91c1c var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-800`,
				`--tw-gradient-to: rgb(153 27 27 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #991b1b var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-900`,
				`--tw-gradient-to: rgb(127 29 29 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #7f1d1d var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-red-950`,
				`--tw-gradient-to: rgb(69 10 10 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #450a0a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-50`,
				`--tw-gradient-to: rgb(255 247 237 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fff7ed var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-100`,
				`--tw-gradient-to: rgb(255 237 213 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ffedd5 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-200`,
				`--tw-gradient-to: rgb(254 215 170 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fed7aa var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-300`,
				`--tw-gradient-to: rgb(253 186 116 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fdba74 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-400`,
				`--tw-gradient-to: rgb(251 146 60 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fb923c var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-500`,
				`--tw-gradient-to: rgb(249 115 22 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f97316 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-600`,
				`--tw-gradient-to: rgb(234 88 12 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ea580c var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-700`,
				`--tw-gradient-to: rgb(194 65 12 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #c2410c var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-800`,
				`--tw-gradient-to: rgb(154 52 18 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #9a3412 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-900`,
				`--tw-gradient-to: rgb(124 45 18 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #7c2d12 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-orange-950`,
				`--tw-gradient-to: rgb(67 20 7 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #431407 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-50`,
				`--tw-gradient-to: rgb(255 251 235 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fffbeb var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-100`,
				`--tw-gradient-to: rgb(254 243 199 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fef3c7 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-200`,
				`--tw-gradient-to: rgb(253 230 138 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fde68a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-300`,
				`--tw-gradient-to: rgb(252 211 77 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fcd34d var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-400`,
				`--tw-gradient-to: rgb(251 191 36 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fbbf24 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-500`,
				`--tw-gradient-to: rgb(245 158 11 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f59e0b var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-600`,
				`--tw-gradient-to: rgb(217 119 6 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #d97706 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-700`,
				`--tw-gradient-to: rgb(180 83 9 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #b45309 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-800`,
				`--tw-gradient-to: rgb(146 64 14 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #92400e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-900`,
				`--tw-gradient-to: rgb(120 53 15 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #78350f var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-amber-950`,
				`--tw-gradient-to: rgb(69 26 3 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #451a03 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-50`,
				`--tw-gradient-to: rgb(254 252 232 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fefce8 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-100`,
				`--tw-gradient-to: rgb(254 249 195 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fef9c3 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-200`,
				`--tw-gradient-to: rgb(254 240 138 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fef08a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-300`,
				`--tw-gradient-to: rgb(253 224 71 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fde047 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-400`,
				`--tw-gradient-to: rgb(250 204 21 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #facc15 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-500`,
				`--tw-gradient-to: rgb(234 179 8 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #eab308 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-600`,
				`--tw-gradient-to: rgb(202 138 4 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ca8a04 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-700`,
				`--tw-gradient-to: rgb(161 98 7 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a16207 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-800`,
				`--tw-gradient-to: rgb(133 77 14 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #854d0e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-900`,
				`--tw-gradient-to: rgb(113 63 18 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #713f12 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-yellow-950`,
				`--tw-gradient-to: rgb(66 32 6 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #422006 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-50`,
				`--tw-gradient-to: rgb(247 254 231 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f7fee7 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-100`,
				`--tw-gradient-to: rgb(236 252 203 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ecfccb var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-200`,
				`--tw-gradient-to: rgb(217 249 157 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #d9f99d var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-300`,
				`--tw-gradient-to: rgb(190 242 100 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #bef264 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-400`,
				`--tw-gradient-to: rgb(163 230 53 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a3e635 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-500`,
				`--tw-gradient-to: rgb(132 204 22 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #84cc16 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-600`,
				`--tw-gradient-to: rgb(101 163 13 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #65a30d var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-700`,
				`--tw-gradient-to: rgb(77 124 15 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #4d7c0f var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-800`,
				`--tw-gradient-to: rgb(63 98 18 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #3f6212 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-900`,
				`--tw-gradient-to: rgb(54 83 20 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #365314 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-lime-950`,
				`--tw-gradient-to: rgb(26 46 5 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #1a2e05 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-50`,
				`--tw-gradient-to: rgb(240 253 244 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f0fdf4 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-100`,
				`--tw-gradient-to: rgb(220 252 231 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #dcfce7 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-200`,
				`--tw-gradient-to: rgb(187 247 208 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #bbf7d0 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-300`,
				`--tw-gradient-to: rgb(134 239 172 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #86efac var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-400`,
				`--tw-gradient-to: rgb(74 222 128 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #4ade80 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-500`,
				`--tw-gradient-to: rgb(34 197 94 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #22c55e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-600`,
				`--tw-gradient-to: rgb(22 163 74 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #16a34a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-700`,
				`--tw-gradient-to: rgb(21 128 61 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #15803d var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-800`,
				`--tw-gradient-to: rgb(22 101 52 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #166534 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-900`,
				`--tw-gradient-to: rgb(20 83 45 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #14532d var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-green-950`,
				`--tw-gradient-to: rgb(5 46 22 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #052e16 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-50`,
				`--tw-gradient-to: rgb(236 253 245 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ecfdf5 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-100`,
				`--tw-gradient-to: rgb(209 250 229 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #d1fae5 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-200`,
				`--tw-gradient-to: rgb(167 243 208 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a7f3d0 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-300`,
				`--tw-gradient-to: rgb(110 231 183 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #6ee7b7 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-400`,
				`--tw-gradient-to: rgb(52 211 153 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #34d399 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-500`,
				`--tw-gradient-to: rgb(16 185 129 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #10b981 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-600`,
				`--tw-gradient-to: rgb(5 150 105 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #059669 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-700`,
				`--tw-gradient-to: rgb(4 120 87 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #047857 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-800`,
				`--tw-gradient-to: rgb(6 95 70 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #065f46 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-900`,
				`--tw-gradient-to: rgb(6 78 59 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #064e3b var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-emerald-950`,
				`--tw-gradient-to: rgb(2 44 34 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #022c22 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-50`,
				`--tw-gradient-to: rgb(240 253 250 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f0fdfa var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-100`,
				`--tw-gradient-to: rgb(204 251 241 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ccfbf1 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-200`,
				`--tw-gradient-to: rgb(153 246 228 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #99f6e4 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-300`,
				`--tw-gradient-to: rgb(94 234 212 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #5eead4 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-400`,
				`--tw-gradient-to: rgb(45 212 191 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #2dd4bf var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-500`,
				`--tw-gradient-to: rgb(20 184 166 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #14b8a6 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-600`,
				`--tw-gradient-to: rgb(13 148 136 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0d9488 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-700`,
				`--tw-gradient-to: rgb(15 118 110 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0f766e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-800`,
				`--tw-gradient-to: rgb(17 94 89 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #115e59 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-900`,
				`--tw-gradient-to: rgb(19 78 74 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #134e4a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-teal-950`,
				`--tw-gradient-to: rgb(4 47 46 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #042f2e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-50`,
				`--tw-gradient-to: rgb(236 254 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ecfeff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-100`,
				`--tw-gradient-to: rgb(207 250 254 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #cffafe var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-200`,
				`--tw-gradient-to: rgb(165 243 252 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a5f3fc var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-300`,
				`--tw-gradient-to: rgb(103 232 249 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #67e8f9 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-400`,
				`--tw-gradient-to: rgb(34 211 238 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #22d3ee var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-500`,
				`--tw-gradient-to: rgb(6 182 212 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #06b6d4 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-600`,
				`--tw-gradient-to: rgb(8 145 178 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0891b2 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-700`,
				`--tw-gradient-to: rgb(14 116 144 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0e7490 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-800`,
				`--tw-gradient-to: rgb(21 94 117 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #155e75 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-900`,
				`--tw-gradient-to: rgb(22 78 99 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #164e63 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-cyan-950`,
				`--tw-gradient-to: rgb(8 51 68 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #083344 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-50`,
				`--tw-gradient-to: rgb(240 249 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f0f9ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-100`,
				`--tw-gradient-to: rgb(224 242 254 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #e0f2fe var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-200`,
				`--tw-gradient-to: rgb(186 230 253 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #bae6fd var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-300`,
				`--tw-gradient-to: rgb(125 211 252 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #7dd3fc var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-400`,
				`--tw-gradient-to: rgb(56 189 248 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #38bdf8 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-500`,
				`--tw-gradient-to: rgb(14 165 233 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0ea5e9 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-600`,
				`--tw-gradient-to: rgb(2 132 199 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0284c7 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-700`,
				`--tw-gradient-to: rgb(3 105 161 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0369a1 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-800`,
				`--tw-gradient-to: rgb(7 89 133 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #075985 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-900`,
				`--tw-gradient-to: rgb(12 74 110 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #0c4a6e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-sky-950`,
				`--tw-gradient-to: rgb(8 47 73 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #082f49 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-50`,
				`--tw-gradient-to: rgb(239 246 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #eff6ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-100`,
				`--tw-gradient-to: rgb(219 234 254 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #dbeafe var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-200`,
				`--tw-gradient-to: rgb(191 219 254 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #bfdbfe var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-300`,
				`--tw-gradient-to: rgb(147 197 253 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #93c5fd var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-400`,
				`--tw-gradient-to: rgb(96 165 250 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #60a5fa var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-500`,
				`--tw-gradient-to: rgb(59 130 246 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #3b82f6 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-600`,
				`--tw-gradient-to: rgb(37 99 235 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #2563eb var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-700`,
				`--tw-gradient-to: rgb(29 78 216 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #1d4ed8 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-800`,
				`--tw-gradient-to: rgb(30 64 175 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #1e40af var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-900`,
				`--tw-gradient-to: rgb(30 58 138 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #1e3a8a var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-blue-950`,
				`--tw-gradient-to: rgb(23 37 84 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #172554 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-50`,
				`--tw-gradient-to: rgb(238 242 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #eef2ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-100`,
				`--tw-gradient-to: rgb(224 231 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #e0e7ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-200`,
				`--tw-gradient-to: rgb(199 210 254 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #c7d2fe var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-300`,
				`--tw-gradient-to: rgb(165 180 252 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a5b4fc var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-400`,
				`--tw-gradient-to: rgb(129 140 248 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #818cf8 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-500`,
				`--tw-gradient-to: rgb(99 102 241 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #6366f1 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-600`,
				`--tw-gradient-to: rgb(79 70 229 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #4f46e5 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-700`,
				`--tw-gradient-to: rgb(67 56 202 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #4338ca var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-800`,
				`--tw-gradient-to: rgb(55 48 163 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #3730a3 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-900`,
				`--tw-gradient-to: rgb(49 46 129 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #312e81 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-indigo-950`,
				`--tw-gradient-to: rgb(30 27 75 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #1e1b4b var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-50`,
				`--tw-gradient-to: rgb(245 243 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f5f3ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-100`,
				`--tw-gradient-to: rgb(237 233 254 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ede9fe var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-200`,
				`--tw-gradient-to: rgb(221 214 254 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ddd6fe var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-300`,
				`--tw-gradient-to: rgb(196 181 253 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #c4b5fd var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-400`,
				`--tw-gradient-to: rgb(167 139 250 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a78bfa var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-500`,
				`--tw-gradient-to: rgb(139 92 246 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #8b5cf6 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-600`,
				`--tw-gradient-to: rgb(124 58 237 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #7c3aed var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-700`,
				`--tw-gradient-to: rgb(109 40 217 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #6d28d9 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-800`,
				`--tw-gradient-to: rgb(91 33 182 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #5b21b6 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-900`,
				`--tw-gradient-to: rgb(76 29 149 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #4c1d95 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-violet-950`,
				`--tw-gradient-to: rgb(46 16 101 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #2e1065 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-50`,
				`--tw-gradient-to: rgb(250 245 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #faf5ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-100`,
				`--tw-gradient-to: rgb(243 232 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f3e8ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-200`,
				`--tw-gradient-to: rgb(233 213 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #e9d5ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-300`,
				`--tw-gradient-to: rgb(216 180 254 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #d8b4fe var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-400`,
				`--tw-gradient-to: rgb(192 132 252 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #c084fc var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-500`,
				`--tw-gradient-to: rgb(168 85 247 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a855f7 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-600`,
				`--tw-gradient-to: rgb(147 51 234 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #9333ea var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-700`,
				`--tw-gradient-to: rgb(126 34 206 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #7e22ce var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-800`,
				`--tw-gradient-to: rgb(107 33 168 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #6b21a8 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-900`,
				`--tw-gradient-to: rgb(88 28 135 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #581c87 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-purple-950`,
				`--tw-gradient-to: rgb(59 7 100 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #3b0764 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-50`,
				`--tw-gradient-to: rgb(253 244 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fdf4ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-100`,
				`--tw-gradient-to: rgb(250 232 255 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fae8ff var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-200`,
				`--tw-gradient-to: rgb(245 208 254 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f5d0fe var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-300`,
				`--tw-gradient-to: rgb(240 171 252 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f0abfc var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-400`,
				`--tw-gradient-to: rgb(232 121 249 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #e879f9 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-500`,
				`--tw-gradient-to: rgb(217 70 239 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #d946ef var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-600`,
				`--tw-gradient-to: rgb(192 38 211 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #c026d3 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-700`,
				`--tw-gradient-to: rgb(162 28 175 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #a21caf var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-800`,
				`--tw-gradient-to: rgb(134 25 143 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #86198f var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-900`,
				`--tw-gradient-to: rgb(112 26 117 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #701a75 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-fuchsia-950`,
				`--tw-gradient-to: rgb(74 4 78 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #4a044e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-50`,
				`--tw-gradient-to: rgb(253 242 248 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fdf2f8 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-100`,
				`--tw-gradient-to: rgb(252 231 243 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fce7f3 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-200`,
				`--tw-gradient-to: rgb(251 207 232 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fbcfe8 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-300`,
				`--tw-gradient-to: rgb(249 168 212 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f9a8d4 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-400`,
				`--tw-gradient-to: rgb(244 114 182 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f472b6 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-500`,
				`--tw-gradient-to: rgb(236 72 153 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ec4899 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-600`,
				`--tw-gradient-to: rgb(219 39 119 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #db2777 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-700`,
				`--tw-gradient-to: rgb(190 24 93 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #be185d var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-800`,
				`--tw-gradient-to: rgb(157 23 77 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #9d174d var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-900`,
				`--tw-gradient-to: rgb(131 24 67 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #831843 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-pink-950`,
				`--tw-gradient-to: rgb(80 7 36 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #500724 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-50`,
				`--tw-gradient-to: rgb(255 241 242 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fff1f2 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-100`,
				`--tw-gradient-to: rgb(255 228 230 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #ffe4e6 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-200`,
				`--tw-gradient-to: rgb(254 205 211 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fecdd3 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-300`,
				`--tw-gradient-to: rgb(253 164 175 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fda4af var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-400`,
				`--tw-gradient-to: rgb(251 113 133 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #fb7185 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-500`,
				`--tw-gradient-to: rgb(244 63 94 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #f43f5e var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-600`,
				`--tw-gradient-to: rgb(225 29 72 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #e11d48 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-700`,
				`--tw-gradient-to: rgb(190 18 60 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #be123c var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-800`,
				`--tw-gradient-to: rgb(159 18 57 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #9f1239 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-900`,
				`--tw-gradient-to: rgb(136 19 55 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #881337 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
			{
				`via-rose-950`,
				`--tw-gradient-to: rgb(76 5 25 / 0)  var(--tw-gradient-to-position); --tw-gradient-stops: var(--tw-gradient-from), #4c0519 var(--tw-gradient-via-position), var(--tw-gradient-to);`,
			},
	...
	},
	{
		...
		Subsection:  "Transition Property",
		Description: "Utilidades para controlar la transición de las propiedades CSS.",
	...
	{
		Section:     "Transitions & Animation",
		Subsection:  "Transition Duration",
		Description: "Utilidades para controlar la duración de las transiciones CSS.",
	...
	{
		Section:     "Transitions & Animation",
		Subsection:  "Transition Timing Function",
		Description: "Utilidades para controlar la suavidad de las transiciones CSS.",
	...
	{
		Section:     "Transitions & Animation",
		Subsection:  "Transition Delay",
		Description: "Utilidades para controlar el retardo de las transiciones CSS.",
	...
	},
	{
		...
		Description: "Utilidades para animar elementos con animaciones CSS.",
	...
	},
	{
		Section:     "Transforms",
		Subsection:  "Scale",
		Description: "Utilidades para escalar elementos con transform.",
	...
	},
	{
		Section:     "Transforms",
		Subsection:  "Rotate",
		Description: "Utilidades para rotar elementos con transform.",
	...
	},
	{
		...
		Description: "Utilidades para traducir elementos con transform.",
	...
	},
	{
		Section:     "Transforms",
		Subsection:  "Skew",
		Description: "Utilidades para sesgar elementos con transform.",
	...
	},
	{
		...
		Description: "Utilidades para especificar el origen de las transformaciones de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para suprimir el estilo nativo de los controles de formulario.",
	...
	},
	{
		Section:     "Interactivity",
		Subsection:  "Cursor",
		Description: "Utilidades para controlar el estilo del cursor al pasar por encima de un elemento.",
	...
	{
		Section:     "Interactivity",
		Subsection:  "Pointer Events",
		Description: "Utilidades para controlar si un elemento responde a eventos de puntero.",
	...
	},
	{
		Section:     "Interactivity",
		Subsection:  "Resize",
		Description: "Utilidades para controlar el cambio de tamaño de un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el comportamiento de desplazamiento de un elemento.",
	...
	{
		Section:     "Interactivity",
		Subsection:  "Scroll Margin",
		Description: "Utilidades para controlar el desplazamiento alrededor de los elementos de un contenedor.",
		...
		Body: [][]string{
			...
			{
				`scroll-mx-0.5`,
				`scroll-margin-left: 0.125rem; /* 2px */ scroll-margin-right: 0.125rem; /* 2px */`,
			},
			{
				`scroll-my-0.5`,
				`scroll-margin-top: 0.125rem; /* 2px */ scroll-margin-bottom: 0.125rem; /* 2px */`,
			},
			...
			{
				`scroll-mx-1`,
				`scroll-margin-left: 0.25rem; /* 4px */ scroll-margin-right: 0.25rem; /* 4px */`,
			},
			{
				`scroll-my-1`,
				`scroll-margin-top: 0.25rem; /* 4px */ scroll-margin-bottom: 0.25rem; /* 4px */`,
			},
			...
			{
				`scroll-mx-1.5`,
				`scroll-margin-left: 0.375rem; /* 6px */ scroll-margin-right: 0.375rem; /* 6px */`,
			},
			{
				`scroll-my-1.5`,
				`scroll-margin-top: 0.375rem; /* 6px */ scroll-margin-bottom: 0.375rem; /* 6px */`,
			},
			...
			{
				`scroll-mx-2`,
				`scroll-margin-left: 0.5rem; /* 8px */ scroll-margin-right: 0.5rem; /* 8px */`,
			},
			{
				`scroll-my-2`,
				`scroll-margin-top: 0.5rem; /* 8px */ scroll-margin-bottom: 0.5rem; /* 8px */`,
			},
			...
			{
				`scroll-mx-2.5`,
				`scroll-margin-left: 0.625rem; /* 10px */ scroll-margin-right: 0.625rem; /* 10px */`,
			},
			{
				`scroll-my-2.5`,
				`scroll-margin-top: 0.625rem; /* 10px */ scroll-margin-bottom: 0.625rem; /* 10px */`,
			},
			...
			{
				`scroll-mx-3`,
				`scroll-margin-left: 0.75rem; /* 12px */ scroll-margin-right: 0.75rem; /* 12px */`,
			},
			{
				`scroll-my-3`,
				`scroll-margin-top: 0.75rem; /* 12px */ scroll-margin-bottom: 0.75rem; /* 12px */`,
			},
			...
			{
				`scroll-mx-3.5`,
				`scroll-margin-left: 0.875rem; /* 14px */ scroll-margin-right: 0.875rem; /* 14px */`,
			},
			{
				`scroll-my-3.5`,
				`scroll-margin-top: 0.875rem; /* 14px */ scroll-margin-bottom: 0.875rem; /* 14px */`,
			},
			...
			{
				`scroll-mx-4`,
				`scroll-margin-left: 1rem; /* 16px */ scroll-margin-right: 1rem; /* 16px */`,
			},
			{
				`scroll-my-4`,
				`scroll-margin-top: 1rem; /* 16px */ scroll-margin-bottom: 1rem; /* 16px */`,
			},
			...
			{
				`scroll-mx-5`,
				`scroll-margin-left: 1.25rem; /* 20px */ scroll-margin-right: 1.25rem; /* 20px */`,
			},
			{
				`scroll-my-5`,
				`scroll-margin-top: 1.25rem; /* 20px */ scroll-margin-bottom: 1.25rem; /* 20px */`,
			},
			...
			{
				`scroll-mx-6`,
				`scroll-margin-left: 1.5rem; /* 24px */ scroll-margin-right: 1.5rem; /* 24px */`,
			},
			{
				`scroll-my-6`,
				`scroll-margin-top: 1.5rem; /* 24px */ scroll-margin-bottom: 1.5rem; /* 24px */`,
			},
			...
			{
				`scroll-mx-7`,
				`scroll-margin-left: 1.75rem; /* 28px */ scroll-margin-right: 1.75rem; /* 28px */`,
			},
			{
				`scroll-my-7`,
				`scroll-margin-top: 1.75rem; /* 28px */ scroll-margin-bottom: 1.75rem; /* 28px */`,
			},
			...
			{
				`scroll-mx-8`,
				`scroll-margin-left: 2rem; /* 32px */ scroll-margin-right: 2rem; /* 32px */`,
			},
			{
				`scroll-my-8`,
				`scroll-margin-top: 2rem; /* 32px */ scroll-margin-bottom: 2rem; /* 32px */`,
			},
			...
			{
				`scroll-mx-9`,
				`scroll-margin-left: 2.25rem; /* 36px */ scroll-margin-right: 2.25rem; /* 36px */`,
			},
			{
				`scroll-my-9`,
				`scroll-margin-top: 2.25rem; /* 36px */ scroll-margin-bottom: 2.25rem; /* 36px */`,
			},
			...
			{
				`scroll-mx-10`,
				`scroll-margin-left: 2.5rem; /* 40px */ scroll-margin-right: 2.5rem; /* 40px */`,
			},
			{
				`scroll-my-10`,
				`scroll-margin-top: 2.5rem; /* 40px */ scroll-margin-bottom: 2.5rem; /* 40px */`,
			},
			...
			{
				`scroll-mx-11`,
				`scroll-margin-left: 2.75rem; /* 44px */ scroll-margin-right: 2.75rem; /* 44px */`,
			},
			{
				`scroll-my-11`,
				`scroll-margin-top: 2.75rem; /* 44px */ scroll-margin-bottom: 2.75rem; /* 44px */`,
			},
			...
			{
				`scroll-mx-12`,
				`scroll-margin-left: 3rem; /* 48px */ scroll-margin-right: 3rem; /* 48px */`,
			},
			{
				`scroll-my-12`,
				`scroll-margin-top: 3rem; /* 48px */ scroll-margin-bottom: 3rem; /* 48px */`,
			},
			...
			{
				`scroll-mx-14`,
				`scroll-margin-left: 3.5rem; /* 56px */ scroll-margin-right: 3.5rem; /* 56px */`,
			},
			{
				`scroll-my-14`,
				`scroll-margin-top: 3.5rem; /* 56px */ scroll-margin-bottom: 3.5rem; /* 56px */`,
			},
			...
			{
				`scroll-mx-16`,
				`scroll-margin-left: 4rem; /* 64px */ scroll-margin-right: 4rem; /* 64px */`,
			},
			{
				`scroll-my-16`,
				`scroll-margin-top: 4rem; /* 64px */ scroll-margin-bottom: 4rem; /* 64px */`,
			},
			...
			{
				`scroll-mx-20`,
				`scroll-margin-left: 5rem; /* 80px */ scroll-margin-right: 5rem; /* 80px */`,
			},
			{
				`scroll-my-20`,
				`scroll-margin-top: 5rem; /* 80px */ scroll-margin-bottom: 5rem; /* 80px */`,
			},
			...
			{
				`scroll-mx-24`,
				`scroll-margin-left: 6rem; /* 96px */ scroll-margin-right: 6rem; /* 96px */`,
			},
			{
				`scroll-my-24`,
				`scroll-margin-top: 6rem; /* 96px */ scroll-margin-bottom: 6rem; /* 96px */`,
			},
			...
			{
				`scroll-mx-28`,
				`scroll-margin-left: 7rem; /* 112px */ scroll-margin-right: 7rem; /* 112px */`,
			},
			{
				`scroll-my-28`,
				`scroll-margin-top: 7rem; /* 112px */ scroll-margin-bottom: 7rem; /* 112px */`,
			},
			...
			{
				`scroll-mx-32`,
				`scroll-margin-left: 8rem; /* 128px */ scroll-margin-right: 8rem; /* 128px */`,
			},
			{
				`scroll-my-32`,
				`scroll-margin-top: 8rem; /* 128px */ scroll-margin-bottom: 8rem; /* 128px */`,
			},
			...
			{
				`scroll-mx-36`,
				`scroll-margin-left: 9rem; /* 144px */ scroll-margin-right: 9rem; /* 144px */`,
			},
			{
				`scroll-my-36`,
				`scroll-margin-top: 9rem; /* 144px */ scroll-margin-bottom: 9rem; /* 144px */`,
			},
			...
			{
				`scroll-mx-40`,
				`scroll-margin-left: 10rem; /* 160px */ scroll-margin-right: 10rem; /* 160px */`,
			},
			{
				`scroll-my-40`,
				`scroll-margin-top: 10rem; /* 160px */ scroll-margin-bottom: 10rem; /* 160px */`,
			},
			...
			{
				`scroll-mx-44`,
				`scroll-margin-left: 11rem; /* 176px */ scroll-margin-right: 11rem; /* 176px */`,
			},
			{
				`scroll-my-44`,
				`scroll-margin-top: 11rem; /* 176px */ scroll-margin-bottom: 11rem; /* 176px */`,
			},
			...
			{
				`scroll-mx-48`,
				`scroll-margin-left: 12rem; /* 192px */ scroll-margin-right: 12rem; /* 192px */`,
			},
			{
				`scroll-my-48`,
				`scroll-margin-top: 12rem; /* 192px */ scroll-margin-bottom: 12rem; /* 192px */`,
			},
			...
			{
				`scroll-mx-52`,
				`scroll-margin-left: 13rem; /* 208px */ scroll-margin-right: 13rem; /* 208px */`,
			},
			{
				`scroll-my-52`,
				`scroll-margin-top: 13rem; /* 208px */ scroll-margin-bottom: 13rem; /* 208px */`,
			},
			...
			{
				`scroll-mx-56`,
				`scroll-margin-left: 14rem; /* 224px */ scroll-margin-right: 14rem; /* 224px */`,
			},
			{
				`scroll-my-56`,
				`scroll-margin-top: 14rem; /* 224px */ scroll-margin-bottom: 14rem; /* 224px */`,
			},
			...
			{
				`scroll-mx-60`,
				`scroll-margin-left: 15rem; /* 240px */ scroll-margin-right: 15rem; /* 240px */`,
			},
			{
				`scroll-my-60`,
				`scroll-margin-top: 15rem; /* 240px */ scroll-margin-bottom: 15rem; /* 240px */`,
			},
			...
			{
				`scroll-mx-64`,
				`scroll-margin-left: 16rem; /* 256px */ scroll-margin-right: 16rem; /* 256px */`,
			},
			{
				`scroll-my-64`,
				`scroll-margin-top: 16rem; /* 256px */ scroll-margin-bottom: 16rem; /* 256px */`,
			},
			...
			{
				`scroll-mx-72`,
				`scroll-margin-left: 18rem; /* 288px */ scroll-margin-right: 18rem; /* 288px */`,
			},
			{
				`scroll-my-72`,
				`scroll-margin-top: 18rem; /* 288px */ scroll-margin-bottom: 18rem; /* 288px */`,
			},
			...
			{
				`scroll-mx-80`,
				`scroll-margin-left: 20rem; /* 320px */ scroll-margin-right: 20rem; /* 320px */`,
			},
			{
				`scroll-my-80`,
				`scroll-margin-top: 20rem; /* 320px */ scroll-margin-bottom: 20rem; /* 320px */`,
			},
			...
			{
				`scroll-mx-96`,
				`scroll-margin-left: 24rem; /* 384px */ scroll-margin-right: 24rem; /* 384px */`,
			},
			{
				`scroll-my-96`,
				`scroll-margin-top: 24rem; /* 384px */ scroll-margin-bottom: 24rem; /* 384px */`,
			},
	...
	{
		Section:     "Interactivity",
		Subsection:  "Scroll Padding",
		Description: "Utilidades para controlar el desplazamiento de un elemento dentro de un contenedor de ajuste.",
		...
		Body: [][]string{
			...
			{
				`scroll-px-0.5`,
				`scroll-padding-left: 0.125rem; /* 2px */ scroll-padding-right: 0.125rem; /* 2px */`,
			},
			{
				`scroll-py-0.5`,
				`scroll-padding-top: 0.125rem; /* 2px */ scroll-padding-bottom: 0.125rem; /* 2px */`,
			},
			...
			{
				`scroll-px-1`,
				`scroll-padding-left: 0.25rem; /* 4px */ scroll-padding-right: 0.25rem; /* 4px */`,
			},
			{
				`scroll-py-1`,
				`scroll-padding-top: 0.25rem; /* 4px */ scroll-padding-bottom: 0.25rem; /* 4px */`,
			},
			...
			{
				`scroll-px-1.5`,
				`scroll-padding-left: 0.375rem; /* 6px */ scroll-padding-right: 0.375rem; /* 6px */`,
			},
			{
				`scroll-py-1.5`,
				`scroll-padding-top: 0.375rem; /* 6px */ scroll-padding-bottom: 0.375rem; /* 6px */`,
			},
			...
			{
				`scroll-px-2`,
				`scroll-padding-left: 0.5rem; /* 8px */ scroll-padding-right: 0.5rem; /* 8px */`,
			},
			{
				`scroll-py-2`,
				`scroll-padding-top: 0.5rem; /* 8px */ scroll-padding-bottom: 0.5rem; /* 8px */`,
			},
			...
			{
				`scroll-px-2.5`,
				`scroll-padding-left: 0.625rem; /* 10px */ scroll-padding-right: 0.625rem; /* 10px */`,
			},
			{
				`scroll-py-2.5`,
				`scroll-padding-top: 0.625rem; /* 10px */ scroll-padding-bottom: 0.625rem; /* 10px */`,
			},
			...
			{
				`scroll-px-3`,
				`scroll-padding-left: 0.75rem; /* 12px */ scroll-padding-right: 0.75rem; /* 12px */`,
			},
			{
				`scroll-py-3`,
				`scroll-padding-top: 0.75rem; /* 12px */ scroll-padding-bottom: 0.75rem; /* 12px */`,
			},
			...
			{
				`scroll-px-3.5`,
				`scroll-padding-left: 0.875rem; /* 14px */ scroll-padding-right: 0.875rem; /* 14px */`,
			},
			{
				`scroll-py-3.5`,
				`scroll-padding-top: 0.875rem; /* 14px */ scroll-padding-bottom: 0.875rem; /* 14px */`,
			},
			...
			{
				`scroll-px-4`,
				`scroll-padding-left: 1rem; /* 16px */ scroll-padding-right: 1rem; /* 16px */`,
			},
			{
				`scroll-py-4`,
				`scroll-padding-top: 1rem; /* 16px */ scroll-padding-bottom: 1rem; /* 16px */`,
			},
			...
			{
				`scroll-px-5`,
				`scroll-padding-left: 1.25rem; /* 20px */ scroll-padding-right: 1.25rem; /* 20px */`,
			},
			{
				`scroll-py-5`,
				`scroll-padding-top: 1.25rem; /* 20px */ scroll-padding-bottom: 1.25rem; /* 20px */`,
			},
			...
			{
				`scroll-px-6`,
				`scroll-padding-left: 1.5rem; /* 24px */ scroll-padding-right: 1.5rem; /* 24px */`,
			},
			{
				`scroll-py-6`,
				`scroll-padding-top: 1.5rem; /* 24px */ scroll-padding-bottom: 1.5rem; /* 24px */`,
			},
			...
			{
				`scroll-px-7`,
				`scroll-padding-left: 1.75rem; /* 28px */ scroll-padding-right: 1.75rem; /* 28px */`,
			},
			{
				`scroll-py-7`,
				`scroll-padding-top: 1.75rem; /* 28px */ scroll-padding-bottom: 1.75rem; /* 28px */`,
			},
			...
			{
				`scroll-px-8`,
				`scroll-padding-left: 2rem; /* 32px */ scroll-padding-right: 2rem; /* 32px */`,
			},
			{
				`scroll-py-8`,
				`scroll-padding-top: 2rem; /* 32px */ scroll-padding-bottom: 2rem; /* 32px */`,
			},
			...
			{
				`scroll-px-9`,
				`scroll-padding-left: 2.25rem; /* 36px */ scroll-padding-right: 2.25rem; /* 36px */`,
			},
			{
				`scroll-py-9`,
				`scroll-padding-top: 2.25rem; /* 36px */ scroll-padding-bottom: 2.25rem; /* 36px */`,
			},
			...
			{
				`scroll-px-10`,
				`scroll-padding-left: 2.5rem; /* 40px */ scroll-padding-right: 2.5rem; /* 40px */`,
			},
			{
				`scroll-py-10`,
				`scroll-padding-top: 2.5rem; /* 40px */ scroll-padding-bottom: 2.5rem; /* 40px */`,
			},
			...
			{
				`scroll-px-11`,
				`scroll-padding-left: 2.75rem; /* 44px */ scroll-padding-right: 2.75rem; /* 44px */`,
			},
			{
				`scroll-py-11`,
				`scroll-padding-top: 2.75rem; /* 44px */ scroll-padding-bottom: 2.75rem; /* 44px */`,
			},
			...
			{
				`scroll-px-12`,
				`scroll-padding-left: 3rem; /* 48px */ scroll-padding-right: 3rem; /* 48px */`,
			},
			{
				`scroll-py-12`,
				`scroll-padding-top: 3rem; /* 48px */ scroll-padding-bottom: 3rem; /* 48px */`,
			},
			...
			{
				`scroll-px-14`,
				`scroll-padding-left: 3.5rem; /* 56px */ scroll-padding-right: 3.5rem; /* 56px */`,
			},
			{
				`scroll-py-14`,
				`scroll-padding-top: 3.5rem; /* 56px */ scroll-padding-bottom: 3.5rem; /* 56px */`,
			},
			...
			{
				`scroll-px-16`,
				`scroll-padding-left: 4rem; /* 64px */ scroll-padding-right: 4rem; /* 64px */`,
			},
			{
				`scroll-py-16`,
				`scroll-padding-top: 4rem; /* 64px */ scroll-padding-bottom: 4rem; /* 64px */`,
			},
			...
			{
				`scroll-px-20`,
				`scroll-padding-left: 5rem; /* 80px */ scroll-padding-right: 5rem; /* 80px */`,
			},
			{
				`scroll-py-20`,
				`scroll-padding-top: 5rem; /* 80px */ scroll-padding-bottom: 5rem; /* 80px */`,
			},
			...
			{
				`scroll-px-24`,
				`scroll-padding-left: 6rem; /* 96px */ scroll-padding-right: 6rem; /* 96px */`,
			},
			{
				`scroll-py-24`,
				`scroll-padding-top: 6rem; /* 96px */ scroll-padding-bottom: 6rem; /* 96px */`,
			},
			...
			{
				`scroll-px-28`,
				`scroll-padding-left: 7rem; /* 112px */ scroll-padding-right: 7rem; /* 112px */`,
			},
			{
				`scroll-py-28`,
				`scroll-padding-top: 7rem; /* 112px */ scroll-padding-bottom: 7rem; /* 112px */`,
			},
			...
			{
				`scroll-px-32`,
				`scroll-padding-left: 8rem; /* 128px */ scroll-padding-right: 8rem; /* 128px */`,
			},
			{
				`scroll-py-32`,
				`scroll-padding-top: 8rem; /* 128px */ scroll-padding-bottom: 8rem; /* 128px */`,
			},
			...
			{
				`scroll-px-36`,
				`scroll-padding-left: 9rem; /* 144px */ scroll-padding-right: 9rem; /* 144px */`,
			},
			{
				`scroll-py-36`,
				`scroll-padding-top: 9rem; /* 144px */ scroll-padding-bottom: 9rem; /* 144px */`,
			},
			...
			{
				`scroll-px-40`,
				`scroll-padding-left: 10rem; /* 160px */ scroll-padding-right: 10rem; /* 160px */`,
			},
			{
				`scroll-py-40`,
				`scroll-padding-top: 10rem; /* 160px */ scroll-padding-bottom: 10rem; /* 160px */`,
			},
			...
			{
				`scroll-px-44`,
				`scroll-padding-left: 11rem; /* 176px */ scroll-padding-right: 11rem; /* 176px */`,
			},
			{
				`scroll-py-44`,
				`scroll-padding-top: 11rem; /* 176px */ scroll-padding-bottom: 11rem; /* 176px */`,
			},
			...
			{
				`scroll-px-48`,
				`scroll-padding-left: 12rem; /* 192px */ scroll-padding-right: 12rem; /* 192px */`,
			},
			{
				`scroll-py-48`,
				`scroll-padding-top: 12rem; /* 192px */ scroll-padding-bottom: 12rem; /* 192px */`,
			},
			...
			{
				`scroll-px-52`,
				`scroll-padding-left: 13rem; /* 208px */ scroll-padding-right: 13rem; /* 208px */`,
			},
			{
				`scroll-py-52`,
				`scroll-padding-top: 13rem; /* 208px */ scroll-padding-bottom: 13rem; /* 208px */`,
			},
			...
			{
				`scroll-px-56`,
				`scroll-padding-left: 14rem; /* 224px */ scroll-padding-right: 14rem; /* 224px */`,
			},
			{
				`scroll-py-56`,
				`scroll-padding-top: 14rem; /* 224px */ scroll-padding-bottom: 14rem; /* 224px */`,
			},
			...
			{
				`scroll-px-60`,
				`scroll-padding-left: 15rem; /* 240px */ scroll-padding-right: 15rem; /* 240px */`,
			},
			{
				`scroll-py-60`,
				`scroll-padding-top: 15rem; /* 240px */ scroll-padding-bottom: 15rem; /* 240px */`,
			},
			...
			{
				`scroll-px-64`,
				`scroll-padding-left: 16rem; /* 256px */ scroll-padding-right: 16rem; /* 256px */`,
			},
			{
				`scroll-py-64`,
				`scroll-padding-top: 16rem; /* 256px */ scroll-padding-bottom: 16rem; /* 256px */`,
			},
			...
			{
				`scroll-px-72`,
				`scroll-padding-left: 18rem; /* 288px */ scroll-padding-right: 18rem; /* 288px */`,
			},
			{
				`scroll-py-72`,
				`scroll-padding-top: 18rem; /* 288px */ scroll-padding-bottom: 18rem; /* 288px */`,
			},
			...
			{
				`scroll-px-80`,
				`scroll-padding-left: 20rem; /* 320px */ scroll-padding-right: 20rem; /* 320px */`,
			},
			{
				`scroll-py-80`,
				`scroll-padding-top: 20rem; /* 320px */ scroll-padding-bottom: 20rem; /* 320px */`,
			},
			...
			{
				`scroll-px-96`,
				`scroll-padding-left: 24rem; /* 384px */ scroll-padding-right: 24rem; /* 384px */`,
			},
			{
				`scroll-py-96`,
				`scroll-padding-top: 24rem; /* 384px */ scroll-padding-bottom: 24rem; /* 384px */`,
			},
	...
	{
		Section:     "Interactivity",
		Subsection:  "Scroll Snap Align",
		Description: "Utilidades para controlar la alineación de desplazamiento de un elemento.",
	...
	{
		Section:     "Interactivity",
		Subsection:  "Scroll Snap Stop",
		Description: "Utilidades para controlar si se pueden omitir posibles posiciones de ajuste.",
	...
	{
		Section:     "Interactivity",
		Subsection:  "Scroll Snap Type",
		Description: "Utilidades para controlar el rigor con el que se aplican los puntos de ajuste en un contenedor de ajuste.",
	...
	{
		Section:     "Interactivity",
		Subsection:  "Touch Action",
		Description: "Utilidades para controlar el desplazamiento y el zoom de un elemento en pantallas táctiles.",
	...
	},
	{
		...
		Description: "Utilidades para controlar si el usuario puede seleccionar texto en un elemento.",
	...
	{
		Section:     "Interactivity",
		Subsection:  "Will Change",
		Description: "Utilidades para optimizar las próximas animaciones de elementos que se espera que cambien.",
	...
	},
	{
		Section:     "SVG",
		Subsection:  "Fill",
		Description: "Utilidades para dar estilo al relleno de los elementos SVG.",
	...
	},
	{
		Section:     "SVG",
		Subsection:  "Stroke",
		Description: "Utilidades para estilizar el trazo de los elementos SVG.",
	...
	},
	{
		...
		Description: "Utilidades para estilizar el ancho del trazo de los elementos SVG.",
	...
	{
		Section:     "Tables",
		Subsection:  "Border Collapse",
		Description: "Utilidades para controlar si los bordes de las tablas deben contraerse o separarse.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el algoritmo de diseño de la tabla.",
	...
	},
	{
		...
		Description: "Utilidades para controlar el sombreado de un elemento.",
	...
	},
	{
		Section:     "Effects",
		Subsection:  "Opacity",
		Description: "Utilidades para controlar la opacidad de un elemento.",
	...
	{
		Section:     "Effects",
		Subsection:  "Mix Blend Mode",
		Description: "Utilidades para controlar cómo un elemento debe mezclarse con el fondo.",
	...
	{
		Section:     "Effects",
		Subsection:  "Background Blend Mode",
		Description: "Utilidades para controlar cómo la imagen de fondo de un elemento debe mezclarse con su color de fondo.",
	...
	},
	{
		Section:     "Filters",
		Subsection:  "Blur",
		Description: "Utilidades para aplicar filtros de desenfoque a un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para aplicar filtros de brillo a un elemento.",
	...
	},
	{
		Section:     "Filters",
		Subsection:  "Contrast",
		Description: "Utilidades para aplicar filtros de contraste a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Drop Shadow",
		Description: "Utilidades para aplicar filtros de sombra a un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para aplicar filtros de escala de grises a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Hue Rotate",
		Description: "Utilidades para aplicar filtros de matiz-rotación a un elemento.",
	...
	},
	{
		Section:     "Filters",
		Subsection:  "Invert",
		Description: "Utilidades para aplicar filtros de inversión a un elemento.",
	...
	},
	{
		Section:     "Filters",
		Subsection:  "Saturate",
		Description: "Utilidades para aplicar filtros de saturación a un elemento.",
	...
	},
	{
		Section:     "Filters",
		Subsection:  "Sepia",
		Description: "Utilidades para aplicar filtros de sepia a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Backdrop Blur",
		Description: "Utilidades para aplicar filtros de desenfoque de fondo a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Backdrop Brightness",
		Description: "Utilidades para aplicar filtros de luminosidad de fondo a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Backdrop Contrast",
		Description: "Utilidades para aplicar filtros de contraste de fondo a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Backdrop Grayscale",
		Description: "Utilidades para aplicar filtros de escala de grises de fondo a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Backdrop Hue Rotate",
		Description: "Utilidades para aplicar filtros de rotación de tonos de fondo a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Backdrop Invert",
		Description: "Utilidades para aplicar filtros de inversión de fondo a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Backdrop Opacity",
		Description: "Utilidades para aplicar filtros de opacidad de fondo a un elemento.",
	...
	{
		Section:     "Filters",
		Subsection:  "Backdrop Saturate",
		Description: "Utilidades para aplicar filtros de saturación de fondo a un elemento.",
	...
	},
	{
		...
		Description: "Utilidades para mejorar la accesibilidad con lectores de pantalla.",
